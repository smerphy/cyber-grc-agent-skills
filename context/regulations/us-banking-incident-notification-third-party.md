...
| Status and key dates | 36-hour rule effective 1 Apr 2022, compliance 1 May 2022. NCUA 72-hour rule effective 1 Sep 2023. 2023 third-party guidance in force, but **proposed replacement guidance published 15 Sep 2026** (91 FR 58536; comments to 16 Nov 2026). FFIEC Cybersecurity Assessment Tool (CAT) sunset 31 Aug 2025. OCC/FDIC rule defining "unsafe or unsound practice" and narrowing matters requiring attention effective 2 Nov 2026 (91 FR 56004) |
...
| Penalties / enforcement | No rule-specific penalty schedule. Enforcement through the general supervisory toolkit: matters requiring attention, s.39 compliance plans, cease-and-desist orders and civil money penalties under 12 U.S.C. 1818 (three statutory tiers, inflation-adjusted annually). From 2 Nov 2026 the OCC and FDIC apply a codified definition of "unsafe or unsound practice" and a narrower test for issuing matters requiring attention (12 CFR 4.92; 12 CFR part 305) |
...
The 2023 third-party guidance applies to "all banking organizations supervised by the agencies" — the OCC, FRB and FDIC; the NCUA was not a party to it, but is a party to the September 2026 replacement proposal. It defines a third-party relationship as *any business arrangement* with another entity, by contract or otherwise — including affiliates, fintech partners, referral arrangements and merchant payment processing.
...
| Clock | "As soon as possible" after that determination — in the final rule the agencies replaced the proposed "immediately" standard with "as soon as possible", so a provider has time to assess the materiality of the disruption; no fixed hour-count applies to the provider notice itself |
...
Supplement A section III (Customer Notice) was amended by the OCC/FDIC reputation-risk final rule (91 FR 18279, 10 Apr 2026; effective 9 Jun 2026): in 12 CFR Part 30 App. B and Part 364 App. B the third sentence of section III was removed and "Effective notice" became "Timely and effective notice". The FRB texts (Part 208 App. D-2 / Part 225 App. F) were not amended and the standard for giving notice is unchanged.
...
Supplemental resources (which the 2026 proposal would also replace): *Third-Party Risk Management: A Guide for Community Banks* (3 May 2024 — OCC Bulletin 2024-11, SR 24-2/CA 24-1, FIL-19-2024); joint statement on bank arrangements with third parties to deliver deposit products (25 Jul 2024 — OCC Bulletin 2024-20, SR 24-5, FIL-45-2024); OCC request for information on community banks' engagement with core and other essential third-party service providers (90 FR 54882, 28 Nov 2025; comments closed 27 Jan 2026), answered by the Joint Statement on Community Banks' Engagement with Core Service Providers issued by the FDIC, OCC and FRB on 11 Sep 2026 (FDIC FIL-58-2026), which explains how core-provider services are supervised on a risk basis.

### 6. Examination expectations

- **FFIEC IT Examination Handbook** — the examiner's reference; booklets updated on their own cycle: *Architecture, Infrastructure, and Operations* (announced 30 Jun 2021, FIL-47-2021); *Development, Acquisition, and Maintenance* (announced 29 Aug 2024, FIL-60-2024); *Business Continuity Management* (2019 (verify)); *Information Security* (2016 (verify)). Booklet-level detail: [../frameworks/ffiec-it-examination-handbook.md](../frameworks/ffiec-it-examination-handbook.md).
- **FFIEC Cybersecurity Assessment Tool** — voluntary self-assessment available since 2015, **sunset 31 Aug 2025** (OCC Bulletin 2024-25, 29 Aug 2024; FDIC FIL-61-2024, 5 Sep 2024). Agencies point instead to NIST CSF 2.0 and CISA's Cybersecurity Performance Goals; see [../frameworks/nist-csf-2.md](../frameworks/nist-csf-2.md).
- **Largest firms** — Interagency Paper on Sound Practices to Strengthen Operational Resilience (SR 20-24, 2 Nov 2020; attachment revised 2 Jun 2026 to remove references to reputational risk) and, for large OCC banks, the Heightened Standards risk-governance framework at 12 CFR Part 30 App. D.

## Enforcement and penalties

| Mechanism | Detail |
|---|---|
| Examination findings | Matters requiring attention (MRAs) and downgraded management/IT ratings are the everyday consequence; guidance breaches surface here, not in court |
| MRA rule, from 2 Nov 2026 (OCC/FDIC) | Final rule 91 FR 56004 (1 Sep 2026) adds 12 CFR 4.92 (OCC) and 12 CFR part 305 (FDIC): an "unsafe or unsound practice" must be contrary to generally accepted standards of prudent operation **and** have materially harmed, or if continued be likely to materially harm, the institution's financial condition or present a material risk of loss to the Deposit Insurance Fund. An MRA may be issued only on that basis or for an **actual violation** of a banking law or regulation, tailored to the institution's size and risk profile. A separate OCC proposal on MRAs for violations of law is out for comment (91 FR 56074) |
...
| 12 Jan 2021 | Notification rule proposed, 86 FR 2299 |
...
| 28 Nov 2025 | OCC request for information on community banks' engagement with core and other essential third-party service providers, 90 FR 54882 (comments closed 27 Jan 2026) |
| 10 Apr 2026 (eff. 9 Jun 2026) | Reputation-risk rule amends Part 30 and Part 364 App. B Supplement A wording |
| 19 May 2026 | Executive Order 14405, *Integrating Financial Technology Innovation into Regulatory Frameworks*, 91 FR 30475 — cited by the agencies as a driver of the 2026 proposal |
| 2 Jun 2026 | SR 20-24 attachment (Sound Practices to Strengthen Operational Resilience) revised to remove references to reputational risk |
| 1 Sep 2026 (eff. 2 Nov 2026) | OCC/FDIC final rule on unsafe or unsound practices and matters requiring attention, 91 FR 56004 (new 12 CFR 4.92 and 12 CFR part 305); companion OCC proposal on MRAs for violations of law, 91 FR 56074 |
| 11 Sep 2026 | FDIC/OCC/FRB Joint Statement on Community Banks' Engagement with Core Service Providers (FDIC FIL-58-2026) |
...
As of 19 September 2026 the 36-hour rule is unamended — 12 CFR Part 53, 12 CFR Part 225 subpart N and 12 CFR Part 304 subpart C still carry their original 2021 source notes, and only Paperwork Reduction Act renewals were published in 2024–2025. The 2023 third-party guidance remains the operative standard until a final replacement issues; the comment period on the replacement closes 16 Nov 2026, so no final guidance is expected before 2027 (verify). The OCC/FDIC MRA rule takes effect 2 Nov 2026 and will change how examination findings on these topics are framed.
...
- **NYDFS Part 500**: New York-licensed institutions add a 72-hour notice to the Department and stricter prescriptive controls (23 NYCRR 500.17). See [us-nydfs-part-500.md](us-nydfs-part-500.md).
- **State breach-notification laws**: customer notice under Supplement A does not displace state statutes; many exempt GLBA-compliant institutions, but the exemption wording varies. See [us-state-breach-notification-laws.md](us-state-breach-notification-laws.md), [us-state-privacy.md](us-state-privacy.md) and [../crosswalks/breach-notification-timelines.md](../crosswalks/breach-notification-timelines.md).
- **CIRCIA**: CISA's 72-hour critical-infrastructure reporting (proposed 89 FR 23644, 4 Apr 2024) is designed to run alongside the banking rule, and the NCUA already aligned its terminology; no final rule had published as of 19 September 2026, so confirm status before building a combined playbook. See [us-circia.md](us-circia.md).
...
- **Frameworks**: NIST CSF 2.0 and CISA CPGs are the agencies' named CAT successors, and examiners work from the FFIEC IT Examination Handbook ([../frameworks/ffiec-it-examination-handbook.md](../frameworks/ffiec-it-examination-handbook.md)); SOC 2 reports remain the standard evidence for service-provider monitoring under Guidelines III.D ([../frameworks/soc2-tsc.md](../frameworks/soc2-tsc.md)).
...
- OCC RFI on core and other essential service providers, 90 FR 54882 (28 Nov 2025): https://www.federalregister.gov/documents/2025/11/28/2025-21333/request-for-information-regarding-community-banks-engagement-with-core-service-providers-and-other ; FDIC FIL-58-2026 (11 Sep 2026), proposal plus Joint Statement on Community Banks' Engagement with Core Service Providers: https://www.fdic.gov/news/financial-institution-letters/2026/proposed-interagency-third-party-risk-management-guidance
...
- Unsafe or Unsound Practices, Matters Requiring Attention, 91 FR 56004 (1 Sep 2026, effective 2 Nov 2026): https://www.federalregister.gov/documents/2026/09/01/2026-17823/unsafe-or-unsound-practices-matters-requiring-attention ; OCC proposal, Violations of Laws or Regulations, 91 FR 56074: https://www.federalregister.gov/documents/2026/09/01/2026-17822/violations-of-laws-or-regulations
- Interagency Paper on Sound Practices to Strengthen Operational Resilience — FRB SR 20-24 (revised 2 Jun 2026): https://www.federalreserve.gov/supervisionreg/srletters/SR2024.htm
- Not reachable when checked: ffiec.gov / ithandbook.ffiec.gov (blocked to automated access) — FFIEC booklet edition dates for Business Continuity Management and Information Security are therefore marked (verify). OCC bulletin pages are served only to interactive browsers; the bulletins cited above were read that way.
