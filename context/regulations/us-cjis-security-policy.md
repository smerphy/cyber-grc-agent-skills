...
| Neighbours | NIST SP 800-53 Rev. 5 (control source), FedRAMP and StateRAMP/GovRAMP (cloud assurance), FISMA (federal agencies), state breach-notification laws (CJI contains PII), IRS Publication 1075 (parallel federal-data regime) |
...
Two structural facts drive practical work. First, the policy was **modernised**: v6.0 (27 December 2024, "Policy Modernization Completion") replaced most of the thirteen numbered policy areas of the 5.9.x series with NIST SP 800-53 Rev. 5 control-family text, keeping Information Exchange Agreements as Policy Area 1 and renumbering Mobile Devices from Policy Area 13 to Policy Area 20, and v6.1 (25 June 2026) folded in the APB's Spring 2025 corrections plus administrative changes approved by the Security and Access Subcommittee on 14 November 2025. Second, since v5.9.5 every modernised control carries an **[Existing]** or **[Priority 1–4]** marking that determines whether it is currently sanctionable (§1.4). Since v6.0 the policy is a public document that "may be posted and shared without restrictions" (§1.5) — earlier versions were distribution-restricted.
...
| Geographic limit | CJI, encrypted or not, may be stored in cloud environments only where they sit physically within an **APB-member country (US, US territories, Indian Tribes, Canada)** and under the legal authority of an APB-member agency — US federal/state/territory, Indian Tribe or the Royal Canadian Mounted Police (SC-28); narrow carve-out for international exchange agreements |
| Role vocabulary (§3.2) | CSA; CJIS Systems Officer (CSO — cannot be outsourced); Terminal Agency Coordinator (TAC); Contracting Agency (CA); Agency Coordinator; CSA Information Security Officer (CSA ISO); "Organizational Personnel with Security Responsibilities" (§3.2.9 — i.e. LASO, ARSO, security point of contact); FBI CJIS ISO; Repository Manager; Interface Agency (IA) Official; State Compact Officer |
...
| IA-5 j | P1 | Authentication at NIST **AAL2**: a multi-factor authenticator, or a memorized secret plus a possession-based single-factor authenticator; cryptographic authenticators use approved cryptography; at least one authenticator replay-resistant; authenticated protected channel; verifiers operated by, and authenticators procured by, federal agencies validated to FIPS 140 Level 1 |
...
| AC-2 (2) | P1 (existing base control) | Automatic removal of temporary and emergency accounts within 72 hours |
...
| IR-6 | P2 | Personnel report suspected incidents immediately, **not to exceed 1 hour after discovery**, to the organisation's IR capability; incident information goes to personnel with incident-handling responsibilities, the CSO / SIB Chief / IA Official **and the FBI CJIS ISO**; supply-chain partners informed (IR-6(3)) |
...
| SA-9 | P2 (existing) | Agencies must **triennially audit all external service providers** with system access, permit inspection of alleged violations, and may conduct unannounced inspections of contractor facilities; a CSA may audit a contractor on behalf of another CSA and share results |
| §5.20 | (policy area) | Mobile devices: 802.11/cellular/Bluetooth/hotspot rules, MDM, wireless risk mitigations, system integrity, and mobile-specific IR, access-control and authentication requirements augmenting the family controls |

### Third parties, cloud and the Security Addendum

- **Security Addendum (App. H)** — the Attorney-General-approved instrument required by 28 CFR §20.33(a)(7) whenever a private contractor performs the administration of criminal justice. The contractor must "maintain a security program consistent with … the CJIS Security Policy in effect when the contract is executed and all subsequent versions" (§3.01); the contracting government agency must give **every contractor employee** a copy of the Addendum and the policy and retain their signed (hand or digital) acknowledgment for audit (§2.01); security violations must be reported to the CSO and the FBI Director, can justify termination, and the FBI may suspend or terminate access and services; on termination contractor records containing CHRI are deleted or returned (§§4.00–4.03); the FBI may perform a final audit of the contractor's systems after the Addendum terminates (§5.01).
- **Cloud (App. G.3, SC-28)** — no "CJIS-certified" status exists; the CJIS ISO Program advises against giving the cloud provider access to CJI encryption keys, restricts CJI storage to APB-member-country jurisdictions, and states that FedRAMP, StateRAMP, SOC 2 and similar authorisations "may be leveraged, however, they do not guarantee compliance." In practice major cloud providers sign the Security Addendum state by state, submit in-scope personnel to CSA fingerprint checks, and publish attestations or third-party (3PAO) assessment reports — Google Cloud's published CJIS page still describes independent 3PAO validation against v6.0, not v6.1, in September 2026.
...
| Civil penalty | 28 CFR §20.25 (34 U.S.C. §10231(d)), adjusted by 28 CFR §85.5 | Up to **$36,498** per violation of subpart B (state/local CHRI systems) for penalties assessed after 3 July 2025; $35,574 for assessments after 12 February 2024 and on or before 3 July 2025. §20.25 also provides for fund cut-off procedures against recipients of assistance. No further DOJ inflation adjustment was in the Code as of September 2026 |
| Contractor consequences | App. H §§4.00–4.03 | Report to CSO and FBI Director; termination of the agreement; FBI suspension/termination of access and telecommunications links, reinstated only after satisfactory assurances |
...
| 2022–2024 | v5.9.1 (1 October 2022) through v5.9.4 (20 December 2023) progressively "modernise" policy areas into 800-53 Rev. 5 control text; v5.9.5 (9 July 2024) adds the Existing/Priority markings (§1.4) |
...
| 25 June 2026 | **v6.1** — "Incorporate Calendar Year 2025 Changes": Spring 2025 APB #16, SA #1–3 (omissions, corrections and additions to the modernised policy, parts 1–3) plus administrative changes approved by the Security and Access Subcommittee on 14 November 2025; approved by the APB and the Compact Council |
| 21 September 2026 | Last date on which FIPS 140-2 certificates are acceptable for CJI encryption; from 22 September 2026 only FIPS 140-3 certified modules or FIPS 197 (AES) ≥256-bit qualify, with an interim allowance for modules already under FIPS 140-3 review (SC-13 note) |
| September 2026 | v6.1 remains the current published version; no v6.2 was in the FBI file repository as of 19 September 2026 |
...
| Ongoing | APB topic cycles run spring and fall (v5.9.5 carried Fall 2023 topics, v6.0 Spring 2024, v6.1 Spring 2025); administrative changes flow through the Security and Access Subcommittee without the full APB process. A v6.2 folding in calendar-year 2026 changes is expected but unannounced (verify) |
...
3. **Retire FIPS 140-2 dependencies now** — the SC-13 cut-off falls on 21 September 2026; inventory VPNs, TLS terminators, HSMs, disk encryption and mobile crypto against active FIPS 140-3 certificates, use the interim allowance only for modules already under FIPS 140-3 review, and track residual gaps formally ([../../skills/exception-management/SKILL.md](../../skills/exception-management/SKILL.md)).
...
- **NIST SP 800-53 Rev. 5** — v6.x lifts control text, discussion and enhancement numbering directly from Rev. 5, with CJIS-specific parameters (e.g., 15/30/60/90-day remediation, 1-hour reporting). An existing 800-53 or FedRAMP Moderate implementation is the natural starting inventory; the deltas are the parameters, the personnel-screening regime and the Security Addendum. IA-5 j reproduces NIST digital-identity AAL2 criteria. See [../frameworks/nist-800-53.md](../frameworks/nist-800-53.md), [../frameworks/nist-800-63-digital-identity.md](../frameworks/nist-800-63-digital-identity.md) and [../crosswalks/framework-crosswalk.md](../crosswalks/framework-crosswalk.md).
- **FedRAMP / StateRAMP** — useful evidence for a cloud provider's control inheritance but explicitly not a substitute for CJIS compliance: App. G.3 names FedRAMP, StateRAMP and "SOC Type 2" as assurances that "may be leveraged, however, they do not guarantee compliance". The state CSA, not FedRAMP, decides. StateRAMP now trades as GovRAMP (stateramp.org resolves to the GovRAMP site). See [../frameworks/fedramp.md](../frameworks/fedramp.md).
- **FISMA** — federal agencies using CJIS systems already run 800-53 baselines under FISMA; the executive summary cites the 2014 Act as further legal basis for the APB-approved requirements. See [us-fisma-federal-cyber.md](us-fisma-federal-cyber.md).
- **IRS Publication 1075** — the closest sibling regime (federal tax information in state agencies): also 800-53-derived, also with background-check and on-site inspection expectations; agencies handling both should harmonise the two control sets. See [us-irs-pub-1075.md](us-irs-pub-1075.md).
- **State breach-notification and privacy laws** — CJI contains PII (§4.3); an incident can trigger the CJIS 1-hour/FBI CJIS ISO chain *and* state resident/AG notification duties. See [us-state-breach-notification-laws.md](us-state-breach-notification-laws.md) and [us-state-privacy.md](us-state-privacy.md).
...
- CJIS Security Policy v6.1, 25 June 2026 — official policy text (FBI file repository): https://le.fbi.gov/file-repository/cjis_security_policy_v6-1_20260625.pdf
- CJIS Security Policy v6.0, 27 December 2024 — prior version, used for the modernisation change summary: https://le.fbi.gov/file-repository/cjis_security_policy_v6-0_20241227.pdf
- CJIS Security Policy v5.9.5, 9 July 2024 — source of the pre-v6 revision history and the first Existing/Priority markings: https://le.fbi.gov/file-repository/cjis_security_policy_v5-9-5_20240709.pdf
- CJIS Security Policy Resource Center — publisher landing page for the current policy, the Requirements Companion Document and use cases: https://le.fbi.gov/cjis-division/cjis-security-policy-resource-center (page refuses scripted requests with HTTP 403; the policy PDFs above are served directly)
...
- 28 CFR §20.25 — penalties provision (legal text, eCFR): https://www.ecfr.gov/current/title-28/section-20.25
- 28 CFR §85.5 — DOJ civil penalty inflation adjustment table (legal text, eCFR): https://www.ecfr.gov/current/title-28/chapter-I/part-85/section-85.5
...
- Secondary, used only for cloud-provider attestation practice: Google Cloud CJIS compliance page https://cloud.google.com/security/compliance/cjis ; AWS CJIS page https://aws.amazon.com/compliance/cjis/ (content not machine-readable); Microsoft CJIS offering page https://learn.microsoft.com/en-us/compliance/regulatory/offering-cjis
- Secondary, for the StateRAMP/GovRAMP naming: https://govramp.org/
