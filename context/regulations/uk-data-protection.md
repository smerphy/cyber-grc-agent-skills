...
| Status and key dates | DPA 2018 Royal Assent 23 May 2018; UK GDPR is the EU text as it stood at IP completion day (31 December 2020, 11 pm), kept up to date with UK amendments (initially via SI 2019/419); DUAA Royal Assent 19 June 2025, data-protection provisions commenced in tranches from 19 June 2025 to 19 June 2026 (main tranche **5 February 2026**); the Information Commission provisions follow on 30 September 2026 |
...
| Breach clocks | 72 hours to the ICO (UK GDPR Art. 33(1)); processor to controller without undue delay (Art. 33(2)); high-risk breaches to individuals without undue delay (Art. 34); PECR service-provider breaches also 72 hours since 20 August 2025 (was 24 hours under retained Commission Regulation (EU) 611/2013) |
| Penalties | **Higher maximum** £17,500,000 or 4% of total worldwide annual turnover, whichever is higher; **standard maximum** £8,700,000 or 2% (UK GDPR Art. 83(4)–(6); DPA 2018 s. 157). PECR infringements on or after 5 February 2026 attract the same two tiers; conduct before that date stays under the old regime, which ran through Part V of the Data Protection Act 1998 and was capped at £500,000 (SI 2010/31 reg. 2) |
...
| PECR | Applies to anyone sending electronic direct marketing to UK subscribers, anyone storing or accessing information on a user's terminal equipment (reg. 6), and providers of public electronic communications services (regs. 5, 5A and 5C) | Reg. 6 is technology-neutral: any storage of, or access to, information on terminal equipment, including instigating it, not only cookies |

The international transfer rules apply to all organisations that handle personal information, including sole traders and self-employed individuals (ICO).

## Core obligations

### Where UK GDPR now diverges from EU GDPR (in force unless stated)

| Topic | Provision | UK rule |
|---|---|---|
| Recognised legitimate interests | UK GDPR Art. 6(1)(ea), Art. 6(5)–(12), Annex 1 (DUAA s. 70, Sch. 4) — from 5 Feb 2026 | New lawful basis with **no balancing test** where processing is necessary for an Annex 1 condition: disclosures to a person who states it needs the data for a public-interest/official-authority task; national security, public security and defence; emergencies (Civil Contingencies Act 2004 meaning); detecting, investigating or preventing crime, or apprehending or prosecuting offenders; safeguarding vulnerable individuals. Secretary of State may add cases by regulations. Not available to public authorities performing their tasks |
| Legitimate-interest examples | Art. 6(11)–(12) (DUAA s. 70) — from 5 Feb 2026 | Statutory examples of processing that may be a legitimate interest: direct marketing; intra-group transmission for internal administrative purposes; ensuring the security of network and information systems (NIS Regulations 2018 meaning). Balancing test still required |
| Purpose limitation | Art. 5(1)(b), new Art. 8A and Annex 2 (DUAA s. 71, Sch. 5) — from 5 Feb 2026 | Art. 8A both codifies the compatibility factors and lists re-uses treated as compatible without a compatibility test: consent to a new specified purpose; research, public-interest archiving or statistics under Art. 84B; checking or demonstrating Art. 5(1) compliance; an Annex 2 condition (public security, emergencies, safeguarding, disclosure to support another body's public task, disclosure for public-interest archiving); or processing authorised by law to safeguard an Art. 23(1)(c)–(j) objective. Old Art. 6(4) is repealed and data collected on consent are more tightly confined |
...
| DSAR search effort | Art. 15(1A) (DUAA s. 78, in force on Royal Assent, expressed as retrospective to 1 January 2024) | The data subject is entitled only to what the controller can provide after a **reasonable and proportionate search** |
| Automated decision-making | Arts. 22A–22D replace Art. 22 (DUAA s. 80) — decisions taken on/after 5 Feb 2026 | See table below |
| Children online | Art. 25(1A)–(1B) (DUAA s. 81) — from 5 Feb 2026 | Providers of information society services likely to be accessed by children must take "children's higher protection matters" into account when deciding technical and organisational measures; the ICO states conformance with its Age Appropriate Design Code (DPA 2018 s. 123) satisfies this |
| International transfers | Arts. 44A, 45A, 45B and Sch. 7 (DUAA s. 85) | Secretary of State approves destinations by regulations if the **data protection test** is met — protection "not materially lower", taken as a whole, than UK GDPR, DPA 2018 Part 2 and Parts 5–7 of that Act so far as relevant to general processing, considering rule of law and human rights, an enforcement authority, redress, onward-transfer rules, international obligations and the country's constitution, traditions and culture. Regulations may be sectoral or transfer-specific (negative procedure) |
...
| Children's digital age of consent | Art. 8(2A)–(2B) and new Art. 8ZA (Children's Wellbeing and Schools Act 2026, c. 21, s. 72 — in force 29 April 2026) | The UK age of consent for information society services stays 13 (Art. 8(1)), but the Secretary of State may now change it by affirmative regulations within a 13–16 band, set a different age for named services or descriptions of service, and make rules on age verification (including monitoring and enforcement). No such regulations had been made as of September 2026 (verify) |
...
| Restrictions (Art. 22B) | Where the decision is based entirely or partly on special-category data, it may be solely automated only where the decision is based entirely on data the subject gave explicit consent for, or where the decision is necessary for a contract with the data subject (or required or authorised by law) **and** Art. 9(2)(g) substantial public interest applies. A solely automated significant decision may **not** rely on the recognised-legitimate-interest basis (Art. 6(1)(ea)) |
...
| Secondary rules (Art. 22D) | Secretary of State may define what counts as meaningful human involvement or a similarly significant effect, and add safeguards (affirmative procedure). the ICO said on 23 June 2026 that it was starting work on a statutory code of practice on artificial intelligence and automated decision-making |
...
| Public electronic communications service provider breach | Notify ICO without undue delay and where feasible within 72 hours (reasons if later); notify affected subscribers/users where the breach is likely to adversely affect them; maintain a breach inventory; £1,000 fixed penalty for failing to notify | PECR regs. 5A, 5C and retained Commission Regulation (EU) 611/2013 Art. 2 (as amended by DUAA s. 111, from 20 Aug 2025) |
| Failure to notify a UK GDPR breach | Fine up to the standard maximum (£8.7m / 2%) plus Art. 58 corrective powers | UK GDPR Art. 83(4)(a) |
...
| Inbound from the EEA | Commission adequacy decisions for the UK (GDPR and Law Enforcement Directive) renewed 19 December 2025, valid to 27 December 2031; EDPB Opinion 26/2025, adopted 16 October 2025, asked the Commission to keep onward transfers, the immigration exemption and the new automated-decision rules under review |
...
| Communications providers (regs. 5, 5A, 5C) | Security measures, 72-hour breach notification, breach inventory, £1,000 fixed penalty for failing to notify; the separate audit power in reg. 5B was revoked on 5 Feb 2026 |
...
| Assessment notice / audit | ss. 146, 146A | May now require the organisation to make arrangements for a **report by an approved person** — the organisation nominates the person, the Commissioner approves (or substitutes) them, and the organisation must give them all reasonable assistance (DUAA s. 98, from 5 Feb 2026) |
...
| 2 Feb 2022 | ICO IDTA (template A.1.0) and UK Addendum (template B.1.0) laid before Parliament under DPA 2018 s. 119A |
| 12 Oct 2023 | UK–US data bridge: SI 2023/1028 in force |
| Mar 2024 | ICO Data Protection Fining Guidance published |
| 19 Jun 2025 | DUAA Royal Assent; ss. 66 and 78 (reasonable and proportionate DSAR searches) in force immediately under s. 142(2); ss. 69, 82, 96, 97 two months later (19 Aug 2025) under s. 142(3) |
...
| 16 Oct 2025 | EDPB Opinion 26/2025 on the draft renewed UK adequacy decision under GDPR |
| 19 Dec 2025 | Commission adopts renewed UK adequacy decisions (GDPR: C(2025) 8771, amending Implementing Decision (EU) 2021/1772; and LED), expiring 27 Dec 2031, after technical extensions adopted 24 Jun 2025 |
...
| 29 Apr 2026 | Children's Wellbeing and Schools Act 2026 s. 72 in force — UK GDPR Art. 8(2A)–(2B) and Art. 8ZA (age of consent and age verification powers) |
| 19 Jun 2026 | s. 103 and Sch. 10 in force: complaints duty (DPA 2018 ss. 164A, 164B), s. 157(4A) penalty tier and Art. 15(1)(ea); ICO records all DUAA data-protection provisions as commenced |
...
| Pending (Sept 2026) | Cyber Security and Resilience (Network and Information Systems) Bill — introduced 12 November 2025, still before Parliament (see [uk-nis-cyber-security-resilience.md](uk-nis-cyber-security-resilience.md)); ICO guidance pipeline continues: separate guidance on the higher PECR fines, final enforcement procedural guidance (draft published, final "in due course") and a new statutory code of practice on AI and automated decision-making, all confirmed as in progress by the ICO on 23 June 2026 |
...
- **EU ePrivacy** ([eu-eprivacy.md](eu-eprivacy.md)): PECR implements the same ePrivacy Directive, but the DUAA consent exemptions in Sch. A1 and the UK-GDPR-level fines are UK-specific — run cookie and marketing compliance on two configurations, not one.
- **EU AI Act** ([eu-ai-act.md](eu-ai-act.md)): UK governance of automated decisions runs through UK GDPR Arts. 22A–22D, DPIAs and the ICO's planned AI/ADM code rather than a horizontal product-safety statute — a lighter but still enforceable layer for UK-only deployments.
...
- UK GDPR as retained and amended (legislation.gov.uk, revised) — Arts. 3, 5, 6, 8, 8A, 8ZA, 12, 12A, 15, 22A–22D, 25, 27, 33, 34, 44A, 45A, 45B, 83, Annexes 1–2: https://www.legislation.gov.uk/eur/2016/679/contents (legal text)
- Data Protection Act 2018 (c. 12) — ss. 114A, 123, 142–157, 164A, 164B, 165, 170, 173, 207, Sch. 16: https://www.legislation.gov.uk/ukpga/2018/12/contents (legal text)
- Data (Use and Access) Act 2025 (c. 18) — Part 5 (ss. 66–116), Part 6 (ss. 117–120), s. 142 commencement, Schs. 4–14: https://www.legislation.gov.uk/ukpga/2025/18/contents (legal text)
- PECR 2003 (SI 2003/2426) — regs. 5A, 5C, 6, 6A, 22, 31, Sch. A1, Sch. 1: https://www.legislation.gov.uk/uksi/2003/2426/contents (legal text)
- DUAA Commencement No. 9 Regulations (SI 2026/1015) — brings ss. 118–119 into force on 30 September 2026 and carries a full table of the earlier commencement instruments (SI 2025/904, 2025/996, 2026/82, 2026/126, 2026/317): https://www.legislation.gov.uk/uksi/2026/1015/made (legal text)
- DUAA Commencement No. 6 and Transitional and Saving Provisions Regulations (SI 2026/82) — the 5 February and 19 June 2026 tranches and the PECR transitional rules in regs. 8–11: https://www.legislation.gov.uk/uksi/2026/82/made (legal text)
- DUAA (Consequential Amendments and Transitional Provision) Regulations 2026 (SI 2026/386) — renaming across the data protection and FOI statute book, in force with DUAA s. 119: https://www.legislation.gov.uk/uksi/2026/386/made (legal text)
- Children's Wellbeing and Schools Act 2026 (c. 21) s. 72 — UK GDPR Art. 8(2A)–(2B) and Art. 8ZA: https://www.legislation.gov.uk/ukpga/2026/21/section/72 (legal text)
- Data Protection (Adequacy) (United States of America) Regulations 2023 (SI 2023/1028) — UK Extension to the EU-US DPF, in force 12 October 2023: https://www.legislation.gov.uk/uksi/2023/1028/made (legal text)
- Data Protection, Privacy and Electronic Communications (Amendments etc) (EU Exit) Regulations 2019 (SI 2019/419) — the conversion of EU GDPR into UK GDPR: https://www.legislation.gov.uk/uksi/2019/419/contents/made (legal text)
- Retained Commission Regulation (EU) 611/2013 — PECR service-provider breach notification, Art. 2 amended to 72 hours: https://www.legislation.gov.uk/eur/2013/611/contents (legal text)
- Data Protection (Monetary Penalties) (Maximum Penalty and Notices) Regulations 2010 (SI 2010/31) — the former £500,000 PECR/DPA 1998 cap: https://www.legislation.gov.uk/uksi/2010/31/made (legal text)
- Network and Information Systems Regulations 2018 (SI 2018/506): https://www.legislation.gov.uk/uksi/2018/506/contents (legal text)
- GOV.UK Cyber Security and Resilience Bill collection: https://www.gov.uk/government/collections/cyber-security-and-resilience-bill (government page)
- ICO adequacy regulations guidance and country list (updated 30 July 2026): https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/international-transfers/adequacy-regulations/is-the-restricted-transfer-covered-by-adequacy-regulations/ (regulator guidance)
- ICO international transfers guide (restricted-transfer three-step test) and appropriate safeguards guidance (IDTA A.1.0, Addendum B.1.0, UK BCRs, TRA): https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/international-transfers/ (regulator guidance)
- ICO personal data breach guide: https://ico.org.uk/for-organisations/report-a-breach/personal-data-breach/personal-data-breaches-a-guide/ (regulator guidance)
- ICO guidance on the use of storage and access technologies (cookies and Sch. A1): https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ (regulator guidance)
- ICO: the DUAA — what does it mean for organisations: https://ico.org.uk/about-the-ico/what-we-do/legislation-we-cover/data-use-and-access-act-2025/the-data-use-and-access-act-2025-what-does-it-mean-for-organisations/ (regulator guidance)
- ICO DUAA summary of the changes (updated 19 June 2026 to record all data-protection provisions in force): https://ico.org.uk/about-the-ico/what-we-do/legislation-we-cover/data-use-and-access-act-2025/the-data-use-and-access-act-2025-duaa-summary-of-the-changes/ (regulator guidance)
- ICO blog, 23 June 2026, "One year on" — PECR higher-fines guidance, draft enforcement procedural guidance and the planned AI/ADM statutory code: https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2026/06/one-year-on-marking-the-12-month-commencement-of-the-data-use-and-access-act/ (regulator statement)
- ICO notice, updated 17 September 2026 — Information Commission from 30 September 2026: https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2026/09/ico-to-become-information-commission-on-30-september-2026/ (regulator statement)
- Information Commissioner Data Protection Fining Guidance, March 2024: https://assets.publishing.service.gov.uk/media/6763eb1fe6ff7c8a1fde9ba4/information_commissioner_data_protection_fining_guidance.pdf (regulator guidance)
- European Commission adequacy decisions page, and the renewal decision of 19 December 2025 (C(2025) 8771) expiring 27 December 2031: https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_en (EU institution page)
- EDPB Opinion 26/2025 on the draft renewed UK adequacy decision, adopted 16 October 2025: https://www.edpb.europa.eu/system/files/2025-10/edpb_opinion_202526_united_kingdom_adequacy_gdpr_en.pdf (EU regulator opinion)
