...
| Operational incident reporting (from 18 March 2027) | All firms with Part 4A permission, PSPs, UK RIEs, registered trade repositories, registered credit rating agencies | UK banks, building societies, PRA-designated investment firms and UK branches of overseas banks; UK Solvency II firms, the Society of Lloyd's and managing agents (scope retained as consulted, PS7/26 ch. 2) | PSPs and CRAs are subsumed into the single regime; a dual-regulated firm makes one submission. The FCA removed credit unions from its *enhanced* reporting tier, so they report on the standard tier |
| MTP notifications and register (from 18 March 2027) | Enhanced-scope SM&CR firms, banks, designated investment firms, building societies, Solvency II firms, CASS large firms, UK RIEs, authorised EMIs/PIs, consolidated tape providers (SUP 15.19.1R, SUP 16.33.1R) | UK banks, building societies, PRA-designated investment firms; Solvency II firms, the Society of Lloyd's and managing agents; UK credit unions with at least £50m total assets. Third-country branches and non-directive firms are excluded (Notifications 2.3B) | Under the FCA rules third-country branches file the register but not notifications (SUP 16.33.3G vs SUP 15.19.3R); the FCA shares branch registers with the PRA. Intragroup arrangements in scope only where there is an external third-party dependency (ring-fenced bodies excepted) |
...
FCA rules (SYSC 15A) and PRA rules (the Operational Resilience Parts; rule numbers below are those cited in the footnotes to SS1/21, March 2022) are deliberately parallel.

| Requirement | FCA rule | PRA rule | What it requires |
|---|---|---|---|
| Identify IBS | SYSC 15A.2.1R; factors 15A.2.4G | Operational Resilience 2.1 | Treat each distinct service separately; factors include client vulnerability, substitutability, time criticality, data sensitivity, potential to inhibit the UK financial system. Review on material change and at least every year (15A.2.2R) |
| Set impact tolerances | SYSC 15A.2.5R; factors 15A.2.7G | 2.2–2.4 | One tolerance per IBS, reflecting peak demand (15A.2.8G); dual-regulated firms set both an FCA (consumer/market harm) and a PRA (safety and soundness / financial stability) tolerance |
...
- **Chapters 6–10** set expectations for outsourcing agreements, data security, access/audit/information rights (including pooled audits and third-party certifications), sub-outsourcing, and business continuity and exit plans covering both stressed and non-stressed exit. Banks are expected (per the EBA Outsourcing Guidelines, SS2/21 para 4.16) to keep an **Outsourcing Register** of all outsourcing arrangements distinguishing material from non-material; the earlier Cloud Register was subsumed by it on 31 December 2021.
...
| Initial phase | As soon as practicable; the FCA expects submission "at the very most, within 24 hours" of determining a threshold is met — an expectation in guidance (SUP 15.18.7G), not a hard deadline, and firms must balance it against containment. PSPs are enhanced-reporting firms but keep the existing requirement to report within 4 hours of first detecting a major operational or security incident |
...
| MTP register | SUP 16.33.6R (FCA) / PRA Reporting Part: maintain a register of all MTP arrangements and submit it annually via FCA RegData on a common Excel template, once the regulators notify firms that the submission window is open (no fixed calendar deadline in the rules). The PRA's BEEDS register collection stops when the requirement takes effect |
| Review | The FCA will review the policies two years after implementation (i.e. from 2029) |
...
| 8–13 July 2026 | SI 2026/777 made 8 July 2026, announced by HM Treasury and the regulators on 10 July, in force 13 July 2026; it designates Amazon Web Services EMEA SARL, Google Cloud EMEA Limited, Microsoft Ireland Operations Limited and Oracle Corporation UK Limited as CTPs with effect from 13 July 2026. Interim self-assessments due within 3 months; mapping and playbook (and the first playbook exercise) within 12 months |
| 18 March 2027 | Incident reporting, MTP notification and annual register rules in force; SS2/21 March 2026 version effective |
| Pending | No further designation regulations had been made as at September 2026 (legislation.gov.uk title search returns SI 2026/777 only); HM Treasury describes the regime as rolling, so further designations are possible. The FCA Handbook records a future SYSC 15A version dated 25 October 2027 whose text is not yet published (verify). The FCA's two-year post-implementation review of the reporting regime falls due from 2029 |
...
6. **Reconcile the Outsourcing Register into the MTP register** (annual RegData submission on the regulators' common template, once they open the submission window) and route new or significantly changed material arrangements through pre-commitment notification. See [../../skills/third-party-risk-assessment/SKILL.md](../../skills/third-party-risk-assessment/SKILL.md) and [../../workflows/vendor-onboarding.md](../../workflows/vendor-onboarding.md).
...
- FCA PS26/2 Operational incident and third party reporting (policy statement page, with links to FG26/3 and FG26/4): https://www.fca.org.uk/publications/policy-statements/ps26-2-operational-incident-third-party-reporting
- FCA PS26/2 including the made rules instrument FCA 2026/6 (SUP 15.18, SUP 15.19, SUP 16.33) (PDF): https://www.fca.org.uk/publication/policy/ps26-2.pdf
- PRA SS1/21 Operational resilience: Impact tolerances for important business services (publication page; current version published 11 March 2022, effective 31 March 2022): https://www.bankofengland.co.uk/prudential-regulation/publication/2021/march/operational-resilience-impact-tolerances-for-important-business-services-ss
- PRA SS1/21 March 2022 text (PDF; source for the Operational Resilience Part rule numbers cited above): https://www.bankofengland.co.uk/-/media/boe/files/prudential-regulation/supervisory-statement/2021/ss121-march-22.pdf
...
- Bank of England CBEST Threat Intelligence-Led Assessments Implementation Guide (phases, durations, accreditation): https://www.bankofengland.co.uk/financial-stability/operational-resilience-of-the-financial-sector/cbest-threat-intelligence-led-assessments-implementation-guide
- Bank of England operational resilience landing page (CBEST, STAR-FS, CQUEST, CBEST thematics): https://www.bankofengland.co.uk/financial-stability/operational-resilience-of-the-financial-sector
- FCA Handbook SUP 15.14 Notifications under the Payment Services Regulations (PSP major-incident reporting; future version dated 18 March 2027): https://www.handbook.fca.org.uk/handbook/SUP/15/14.html
...
- Not fetched directly during this review: the PRA Rulebook online text of the Operational Resilience, Notifications and Reporting Parts, and the PS16/24 / SS6/24 / SS7/24 PDFs (their existence, dates and titles were confirmed from the Bank's Critical Third Parties page above). PRA Rulebook rule numbers cited here come from the footnotes to SS1/21 (March 2022), SS2/21 and PS7/26; confirm against the Rulebook before relying on them.
