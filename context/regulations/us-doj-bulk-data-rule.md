...
| Status and key dates | In force. Prohibitions and restrictions effective 12:01 a.m. ET, 8 April 2025 (§ 202.216); due-diligence, audit and reporting duties (subpart J, §§ 202.1103–202.1104) operative from 6 October 2025; NSD limited-enforcement policy covered 8 April–8 July 2025 |
...
| Penalties | IEEPA: civil up to the greater of $368,136 (inflation-adjusted) or twice the transaction value; criminal (willful) up to $1,000,000 and 20 years' imprisonment (§ 202.1301). Knowledge standard, not strict liability |
...
| § 202.303 | Any covered data transaction giving a country of concern or covered person access to bulk human 'omic data or to human biospecimens from which it could be derived — includes vendor and employment agreements, which are otherwise only restricted |
...
| Internal data risk assessment (Section I.C) | Evaluates whether the chosen Section II mix prevents access to data that is linkable, identifiable, unencrypted or decryptable with commonly available technology; includes mitigation strategy; reviewed annually (NIST Privacy Framework ID.RA-P1..P5) |
...
General licences (self-executing, published on NSD's site and in the Federal Register; may carry reporting conditions) and specific licences (case-by-case; DOJ policy is not to grant a specific licence where a general licence applies). Advisory opinions (§ 202.901) state NSD's present enforcement intentions for an actual, disclosed, prospective transaction; hypothetical and anonymous requests are refused.
...
- **Standard of liability**: "knowingly" — actual knowledge or reason to know (FAQ 103/107). NSD weighs sophistication, scale and sensitivity of data, and evidence of evasion; voluntary self-disclosure and cooperation are mitigating. NSD has said further enforcement guidance on self-disclosure and mitigating factors is forthcoming (status as of September 2026: verify).
- **Limited-enforcement window**: 8 April–8 July 2025, NSD did not prioritize civil enforcement against persons making good-faith efforts to comply (evidence: data-flow reviews, contract renegotiation, deploying the CISA measures). Egregious willful violations were still pursued. The window has closed; no successor policy was located.
...
| 6 Oct 2025 | Subpart J (compliance program, audits) and §§ 202.1103–202.1104 (annual and rejected-transaction reports) operative |
| 1 Mar 2026 | First annual reports due under § 202.1103 for calendar 2025 (only the cloud/25%-owned cohort) |
| Sep 2026 | No Federal Register document amending Part 202 has been published since 18 April 2025. DOJ's regulatory agenda still carries RIN 1124-AA01 as a long-term action. EO 14117 Sec. 5 required an Attorney General report to the President within one year of the rule's effective date (i.e. by April 2026); not published (verify). Watch for general licences, Covered Persons List designations and new FAQs on the NSD data-security page |
...
- CISA, Security Requirements for Restricted Transactions (E.O. 14117 Implementation), January 2025 (incorporated by reference; PDF): https://www.cisa.gov/sites/default/files/2025-01/Security_Requirements_for_Restricted_Transaction-EO_14117_Implementation508.pdf — landing page https://www.cisa.gov/resources-tools/resources/EO-14117-security-requirements; notice of availability 90 FR 1528
...
- DOJ NSD, Implementation and Enforcement Policy Through July 8, 2025, 11 April 2025 (regulator guidance): https://www.justice.gov/opa/media/1396346/dl?inline
...
- DOJ Regulatory Agenda entry, RIN 1124-AA01, 22 September 2025 (status check): https://www.federalregister.gov/documents/2025/09/22/2025-18331/regulatory-agenda
