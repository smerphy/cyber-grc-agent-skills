...
| § 3553(b) | DHS Secretary (through CISA) administers implementation for non-NSS systems, issues BODs (including incident-reporting and annual-report content requirements, exigent-risk mitigation), monitors agencies, deploys technology on request; must consult NIST on directives implementing NIST standards and ensure directives do not conflict with them (§ 3553(f)(2)) |
...
|---|---|---|---|
| Any incident (§ 3552 definition) | CISA | Within 1 hour of identification by the top-level CSIRT/SOC/IT department; seven mandatory data elements (functional impact, information impact, recoverability, detection time, systems/records/users affected, network location, POC); severity scored with CISA's Cyber Incident Scoring System (NCISS), aligned to the Cyber Incident Severity Schema | CISA Federal Incident Notification Guidelines (effective 1 Apr 2017) |
...
| Major incident | Congressional committees in § 3554(c)(1), plus the agency's Inspector General | Not later than 7 days after there is a reasonable basis to conclude it occurred; supplemental updates as information develops; description in the annual report | § 3554(b)(7)(C)(iii)(III); M-25-04 |
...
|---|---|---|
| M-25-04 FY2025 FISMA guidance | 15 Jan 2025 | Rescinds M-24-04. Major-incident definition and 1-hour OMB/CISA reporting; FY2025 deadlines (IG metrics 1 Aug 2025; annual CIO/SAOP metrics, agency and IG reports, agency-head letter 31 Oct 2025; quarterly CIO metrics). IG metrics on a multi-year cycle: core metrics annually, remainder on a 2-year cycle; CFO Act IGs summarize results by CSF capability level. Still the operative annual FISMA guidance: OMB's memoranda index runs to M-26-19 (10 Sep 2026) with no FY2026 successor |
...
| M-26-05 Risk-based software and hardware security | 23 Jan 2026 | **Rescinds M-22-18 and M-23-16** — the common Secure Software Development Attestation Form is no longer mandatory. Agencies keep complete software/hardware inventories, set assurance policies matched to risk, may still use the form, request SBOMs contractually, and reference SP 800-218 (SSDF), CISA 2025 SBOM minimum elements and the HBOM framework |
| M-26-14 Logging and network visibility | 22 May 2026 | **Rescinds M-21-31.** Two objectives: Continuous Event Monitoring (SOC real-time) and Threat Hunting, Investigation, Response and Forensics (hot/cold storage, centralized retrieval); applies to all agency and third-party-operated systems including IoT/OT. CISA publishes a Logging Reference Architecture (LRA) within 90 days of the memo; agencies then submit an Agency Logging Plan to OMB and CISA within 90 days of LRA publication and reach maturity Level 1 by LRA+120 days, Level 2 by +180, Level 3 by +320; revised maturity model (Appendix C) reported as percentage of systems per level; logs provided to CISA/FBI on request |
| M-26-15 Post-quantum cryptography migration | 24 Jun 2026 | Implements EO 14412 (22 Jun 2026) and the Quantum Computing Cybersecurity Preparedness Act: prioritized migration of cryptographic systems as feasible by 31 Dec 2030, phased to full migration by 2035; migration plan to OMB/ONCD within 120 days; automated cryptographic inventory; TLS 1.3 by 2 Jan 2030 |
...
| BOD 26-02 End-of-support edge devices | 5 Feb 2026 | Immediately update vendor-supported devices running EOS software; inventory devices on CISA's EOS Edge Device List and report to CISA within 3 months; within 12 months decommission those devices and inventory devices becoming EOS in the following year; remove all identified EOS edge devices within 18 months; continuous discovery and decommissioning process within 24 months |
| BOD 26-04 Prioritizing security updates based on risk | 10 Jun 2026 | **Supersedes and revokes BOD 19-02 and BOD 22-01 (KEV).** Remediation deadlines come from a four-factor matrix (Table 1): public exposure, KEV listing, adversary automatability and technical impact (total vs partial control). The highest-risk combination (publicly exposed, KEV-listed, automatable, total control) carries the shortest deadline plus forensic triage and the lowest-risk combination is fixed on system upgrade; mid-tier combinations run out to 30 days — read the exact day counts off Table 1 (verify). Phase II within 60 days, Phase III within 180 days (7 Dec 2026). KEV status via CDM or bi-weekly manual reporting; agencies without CDM report exposed assets every 7 days; publicly reachable assets tagged by organization, environment, exposure and asset type within 180 days; quarterly attestation of publicly exposed IP space and agency domains through the Cyber Hygiene scope-change process |

Emergency Directives are issued under § 3553(h) for specific campaigns (e.g., ED 25-03 V1 on compromise of Cisco devices; ED 26-03 V1 on Cisco SD-WAN vulnerabilities) and carry short, product-specific deadlines; track the directives index for supplements and V1 revisions. The FedRAMP PMO mirrored BOD 26-04 for cloud providers: Vulnerability Detection and Response / Vulnerability Evaluation and Reporting rules mandatory 7 Dec 2026, non-compliant authorizations revoked after 7 Mar 2027.
...
| EO 14412 Securing the Nation Against Advanced Cryptographic Attacks | 22 Jun 2026, 91 FR 38483 | In force. Each agency names a PQC migration lead within 30 days; OMB guidance within 90 days (delivered as M-26-15) requiring review of HVA and high-impact system inventories, PQC for key establishment by 31 Dec 2030 and for digital signatures by 31 Dec 2031, and a migration plan; NIST PQC pilot completed by 31 Dec 2027; FAR proposed rule within 180 days to require covered contractors to meet PQC-incorporating FIPS by 31 Dec 2030, and within 270 days a rule on contractor vulnerability disclosure policies covering cryptographic weaknesses |

## Enforcement and penalties

FISMA carries no fines or private right of action. Consequences are institutional: OMB may withhold or condition IT funding (§ 3553(a)(5), 40 U.S.C. § 11303); CISA directives are compulsory and non-compliance is reported to OMB and Congress; the IG's annual evaluation and FISMA metrics feed public scorecards, GAO reports and appropriations oversight; an authorizing official may deny or revoke an ATO. For contractors, the practical sanctions are contractual — cure notices, termination, past-performance impact and, where security compliance is misrepresented, civil False Claims Act exposure.
...
| 22 Jun 2026 | EO 14412 on advanced cryptographic attacks (91 FR 38483) |
| 23 Jun 2026 | FAR CUI clause re-proposed as FAR 52.240-7 inside the FAR overhaul proposed rule (91 FR 37550, implementing EO 14275); 72-hour reporting, SP 800-171 Rev. 3, FedRAMP Moderate-equivalent cloud; comments closed 23 Jul 2026; **not final as of Sept 2026** |
...
| Pending | The statute itself is unamended since the 2018 supply-chain amendment; FISMA reauthorization bills have been introduced in successive Congresses without enactment (verify). The EO 14306 SSDF refresh is still outstanding — SP 800-218 remains version 1.1 (Feb 2022). OMB must revise Circular A-130 by June 2028; FedRAMP's statutory authority (44 U.S.C. §§ 3607–3616) self-repeals on 23 Dec 2027 unless extended |
...
- FAR 52.204-21 (acquisition.gov, FAC 2026-01): https://www.acquisition.gov/far/52.204-21 · Proposed FAR CUI rule, 15 Jan 2025 (90 FR 4278): https://www.federalregister.gov/documents/2025/01/15/2024-30437/federal-acquisition-regulation-controlled-unclassified-information · Re-proposal within the FAR overhaul, 23 Jun 2026 (91 FR 37550), official text: https://www.govinfo.gov/content/pkg/FR-2026-06-23/pdf/2026-12559.pdf
- NIST SP 800-218 (SSDF) publication page, used to confirm that no updated edition has been finalised: https://csrc.nist.gov/pubs/sp/800/218/final
