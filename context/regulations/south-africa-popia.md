...
| Exemptions (s.37) | Regulator may, by Gazette notice, exempt processing that would otherwise breach a condition where the s.37(1) circumstances are met; the exemption application form and a 2021 guidance note are published by the Regulator |
...
| 8 Data subject participation | ss.23–25 | Access, correction and deletion rights (Form 2) |
...
- **s.20** — operators process only with the responsible party's knowledge or authorisation and keep information confidential.
- **s.21(1)** — a **written contract** must bind the operator to the s.19 measures; **s.21(2)** — the operator must notify the responsible party **immediately** on reasonable grounds to believe personal information has been accessed or acquired by an unauthorised person.
...
|---|---|
| Threshold | "POPIA does not have a threshold for reporting of security compromises. All security compromises must be reported irrespective of the deemed level of risk" (Regulator FAQ). A compromise includes intentional or accidental loss, sharing or destruction, and incidents at operators |
...
| Operator incidents | The responsible party reports; the operator's duty is to notify the responsible party immediately (s.21(2)) |
...
| Codes of conduct (ss.60–68) | Regulator-issued sector codes; Banking Association (BASA) and Credit Bureau Association (CBA) codes approved 12 October 2022; further codes proposed for direct marketing (DMASA, 2023), research (2023), residential communities/gated access (2023–2026) |
...
|---|---|---|
| 9 May 2023 | Department of Justice and Constitutional Development — enforcement notice after the September 2021 ransomware attack | Findings under s.19(1)–(3) and s.22(1): expired SIEM, intrusion-detection and anti-virus licences since 2020; no PIIA or compliance framework; 31-day remediation orders |
| 3 July 2023 | Same matter — infringement notice, **R5 million** administrative fine | First published s.109 fine; imposed for non-compliance with the enforcement notice |
...
| 21 Feb 2024 | FT Rams Consulting — enforcement notice | s.95 notice against a private-sector consultancy (published in redacted form) |
...
| 16 Apr 2025 | WhatsApp — enforcement notice under s.95 | Cross-border platform brought under the Act (notice contents not extracted here — verify) |
...
| Provision | Content |
|---|---|
| ss.2–7 | Unlawful access; unlawful interception of data; unlawful acts in respect of software or hardware tools; unlawful interference with data or a computer program; unlawful interference with a storage medium or computer system; unlawful acquisition, possession, provision, receipt or use of passwords, access codes or similar data |
| ss.8–11 | Cyber fraud; cyber forgery and uttering; cyber extortion; **aggravated offences** against a "restricted computer system" — one under the control of, or exclusively used by, a financial institution or an organ of state (including a court) and protected by security measures |
...
| 8 | Cybersecurity hygiene practices (8.1–8.7), including multi-factor authentication (8.3) and malware scanning |
| 9 | Notify the responsible authority, in the form and manner determined, after classifying a cyber incident or information-security compromise as **material** |
| Joint Notice 2 of 2026 (31 Aug 2026, effective 1 Sep 2026) | Material incident = disruption with severe and widespread impact on operations, customers or the financial system. Template submission: initial **within 24 hours** of classification as material (for both Joint Standard 1 of 2023 IT incidents and Joint Standard 2 of 2024 cyber incidents); update with all tabs and final investigation report **within 14 calendar days** of the initial notification. Banks, mutual banks and insurers file via the Prudential Authority's Umoja portal; CIS managers, market infrastructures, FSPs, pension funds and administrators, OTC derivative providers and credit rating agencies via the FSCA Joint Standards Submission Portal. The Prudential Authority intends to withdraw Directive 2 of 2019 (banks) |
...
| 1 Jul 2021 | s.58(2) (suspension pending prior-authorisation review) commenced (GG 44383); full enforceability |
...
| 12 Oct 2022 | BASA and CBA codes of conduct approved |
| 15–16 May 2024 | Joint Standard 2 of 2024 published (Joint Communication 2 of 2024) |
...
| 26 Sep 2025 | Draft Regulations on processing of health or sex-life information under s.112(2)(c) published for comment (GG 53426; comments closed 10 Oct 2025) — final regulations not located as of September 2026 (verify) |
...
No amendment to POPIA's text was identified in official sources as of September 2026. The Cybercrimes Act s.54 reporting duty and the ss.41–44 preservation and disclosure directions remain uncommenced on the official record fetched (verify against the latest proclamations).
...
7. **Control marketing and profiling**: Form 4 consent capture, once-only approach, opt-out in every message, records of consent; assess automated decisions against s.71. See [../../skills/policy-authoring/SKILL.md](../../skills/policy-authoring/SKILL.md).
8. **Gate transfers**: map foreign recipients and choose a s.72 mechanism (binding agreement or BCRs); prior authorisation for special or children's data to non-adequate countries.
9. **Board reporting for financial institutions**: governing-body approval of strategy and framework, annual reviews, penetration-test and simulation results, material-incident log. See [../../skills/grc-metrics-reporting/SKILL.md](../../skills/grc-metrics-reporting/SKILL.md).
10. **Watch the horizon**: s.54 commencement, health/sex-life regulations, the DBE appeal (scope of Regulator powers), and further codes of conduct. See [../../skills/regulatory-horizon-scanning/SKILL.md](../../skills/regulatory-horizon-scanning/SKILL.md).
...
- **PAIA**: the same Regulator enforces access-to-information duties; the PAIA manual is the POPIA s.17 documentation record, and PAIA annual reports are a recurring compliance filing.
- **Consumer Protection Act**: the 2026 opt-out registry sits alongside, not instead of, s.69 consent.
- Other African and emerging-market regimes are summarised in [other-jurisdictions.md](other-jurisdictions.md); framework mapping via [../frameworks/nist-csf-2.md](../frameworks/nist-csf-2.md) and [../crosswalks/framework-crosswalk.md](../crosswalks/framework-crosswalk.md).

## Primary sources

- POPIA, Act 4 of 2013 (legal text, GG 37067): https://www.gov.za/sites/default/files/gcis_document/201409/3706726-11act4of2013protectionofpersonalinforcorrect.pdf
- POPIA commencement proclamations (gov.za notices): https://www.gov.za/documents/protection-personal-information-act-commencement-certain-sections-22-jun-2020-0000 and https://www.gov.za/documents/protection-personal-information-act-commencement-section-582-1-apr-2021-0000; commencement list on https://www.gov.za/documents/protection-personal-information-act
- Regulations relating to the Protection of Personal Information, 2018 (legal text): https://inforegulator.org.za/wp-content/uploads/2020/07/20181214-gg42110-rg10897-gon1383-POPIA-Regulations-1.pdf
- Information Regulator — POPIA page, forms, guidance notes, enforcement notices and media statements (regulator guidance): https://inforegulator.org.za/popia/ ; https://inforegulator.org.za/popia-forms/ ; https://inforegulator.org.za/enforcement-notices/ ; https://inforegulator.org.za/media-statements/ ; https://inforegulator.org.za/acts/
- Guidelines on completing a s.22 security compromise notification: https://inforegulator.org.za/wp-content/uploads/2020/07/Guidelines-on-completing-a-Security-Compromise-Notification-ito-Section-22-POPIA.pdf ; eServices portal guide: https://eservices.inforegulator.org.za/compromises/docs/guide.pdf
- Guidance Note on Information Officers: https://inforegulator.org.za/wp-content/uploads/2025/07/Guidance_Note_on_Information_Officers_.pdf ; Guidance Note on Direct Marketing: https://inforegulator.org.za/wp-content/uploads/2020/07/GUIDANCE-NOTE-ON-DIRECT-MARKETING-IN-TERMS-OF-THE-PROTECTION-OF-PERSONAL-INFORMATION-ACT-4-OF-2013-POPIA.pdf
- Enforcement and infringement notices and statements: DoJ&CD enforcement notice (9 May 2023) and R5m infringement statement (4 Jul 2023); Dis-Chem enforcement notice (5 Feb 2024); DBE infringement statement (23 Dec 2024); DBE appeal statement (31 Dec 2025); Blouberg statement (29 Apr 2026); CJC/Sibanye statement (2 Jun 2026) — all under https://inforegulator.org.za/wp-content/uploads/ . The WhatsApp enforcement notice PDF (16 Apr 2025) is an image scan; its contents were not extracted.
- Draft s.112(2)(c) health/sex-life regulations (GG 53426, 26 Sep 2025): https://inforegulator.org.za/wp-content/uploads/2025/10/SECTION-112_2_C_-HEALTH-REGULATIONS-FINAL-1.pdf
- Cybercrimes Act 19 of 2020 (legal text, GG 44651): https://www.gov.za/sites/default/files/gcis_document/202106/44651gon324.pdf ; commencement summary (Proclamation in GG 45562): https://www.gov.za/documents/cybercrimes-act-19-2020-1-jun-2021-0000
- Joint Standard 2 of 2024 — Cybersecurity and Cyber Resilience Requirements, with Joint Communication 2 of 2024 (publisher documents, FSCA document store): https://www.fsca.co.za/ (Supervisory Information → Standards → Joint Standards; served via the site's document API)
- Joint Notice 2 of 2026 — Determination of the Notification Template, with Joint Communication 5 of 2026 and the incident template (publisher documents, FSCA): https://www.fsca.co.za/ (Notices)
- Not fetched: the Prudential Authority (SARB) mirror pages for the Joint Standards returned 404; the FSCA search and listing pages load dynamically and were read through the document API instead.
