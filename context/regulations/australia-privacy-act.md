...
| Attribute | Detail |
|---|---|
| Instrument | Privacy Act 1988 (Cth), Act No. 119, 1988. Current compilation No. 104 (C2026C00227), compiled 4 June 2026, incorporating amendments to Act No. 75, 2025. Supported by the Privacy Regulations 2025 (F2025L01377, made 13 November 2025, commenced 1 April 2026 and repealing the sunsetting Privacy Regulation 2013) |
| Regulator | Office of the Australian Information Commissioner (OAIC) — Information Commissioner and Privacy Commissioner. The Act is administered by the Attorney-General's Department |
...
Notification volumes (OAIC statistics published 6 July 2026): 1,205 notifications in the 2025 calendar year — the highest since the scheme began in 2018 and 8% above the 1,112 of 2024; 716 were attributed to malicious or criminal attack; health service providers led by sector (225 notifications, 19%), ahead of financial services (157) and the Australian Government (118). Log every assessment and notification decision in a register such as [../../templates/incident-regulatory-notification-log.md](../../templates/incident-regulatory-notification-log.md).

### Statutory tort for serious invasions of privacy (Schedule 2, s 94A)

In force 10 June 2025. Cause of action (cl 7(1)), all five elements required: intrusion upon seclusion or misuse of information relating to the plaintiff; a reasonable expectation of privacy; the invasion was intentional or reckless; it was serious; and the public interest in the plaintiff's privacy outweighed any countervailing public interest. Actionable without proof of damage (cl 7(2)). Defences: lawful authority, express or implied consent, necessity to prevent or lessen a serious threat, lawful defence of persons or property, and the defamation defences of absolute privilege, public documents and fair report (cl 8). Non-economic plus exemplary damages are capped at the greater of A$478,550 and the defamation non-economic-loss cap (cl 11(5)); aggravated damages are excluded (cl 11(2)). Proceedings must start before the earlier of 1 year after the plaintiff became aware and 3 years after the invasion (before the 21st birthday if the plaintiff was a minor), extendable by court order to no later than 6 years (cl 14). Exemptions for journalists, agencies and State/Territory authorities, law enforcement and intelligence bodies, and defendants under 18 (cll 15–18). The tort applies to anyone, including small businesses outside the APPs.
...
| Interference | s 13H | 2,000 penalty units; s 13G(4) disapplies the Regulatory Powers Act s 82(5)(a) ×5 body-corporate multiplier for s 13G only, so a ×5 uplift may apply here (verify) | Court may fall back to s 13H where s 13G seriousness is not proven (s 13J) |
...
Enforcement record: the first court-imposed civil penalties came in *Australian Information Commissioner v Australian Clinical Labs Limited (No 2)* [2025] FCA 1224 (orders 8 October 2025) — A$5.8m in total (A$4.2m for the APP 11.1 failure, pleaded as more than 223,000 contraventions of s 13G; A$800,000 for the s 26WH(2) assessment failure; A$800,000 for failing to give the Commissioner a statement as soon as practicable under s 26WK(2)) over a February 2022 breach of the Medlab Pathology business affecting more than 223,000 individuals, under the pre-December 2022 ceiling of A$2.22m per contravention; liability was admitted. Civil-penalty proceedings against Optus were filed on 8 August 2025 (alleged s 13G contravention affecting about 9.5 million people; conduct 17 October 2019–20 September 2022; pre-2022 maximum A$2.22m per contravention, pleaded per individual). Proceedings against Medibank Private were filed on 5 June 2024 over its October 2022 breach (alleged s 13G contravention affecting 9.7 million people; conduct March 2021–October 2022; same A$2.22m per-contravention ceiling) and remain before the Federal Court (verify current status). During 2026 the Commissioner also issued determinations against Optus over unlisted White Pages entries and against providers that leaked sensitive information through third-party tracking pixels.
...
3. **Build the NDB clock into incident response**: suspicion → 30-day assessment; belief → statement to the OAIC and individual notification, each as soon as practicable; remedial-action analysis documented at each step. Run the [../../workflows/incident-regulatory-response.md](../../workflows/incident-regulatory-response.md) workflow and [../../skills/incident-regulatory-reporting/SKILL.md](../../skills/incident-regulatory-reporting/SKILL.md); plan now for the proposed 72-hour deadline.
...
- Exposure draft Privacy Amendment (Personal Data Protection) Bill 2026 and consultation page — Attorney-General's Department: https://consultations.ag.gov.au/rights-and-protections/privacy-reform/ (exposure draft PDF: https://consultations.ag.gov.au/rights-and-protections/privacy-reform/user_uploads/exposure-draft-bill-2026.pdf)
...
- OAIC, "Data breach notifications increase to all-time high in 2025, new NDB stats show" (6 July 2026) — regulator media release with the calendar-2025 statistics: https://www.oaic.gov.au/news/media-centre/data-breach-notifications-increase-to-all-time-high-in-2025%2C-new-ndb-stats-show
- OAIC, notifiable data breaches publications index (half-yearly reports to July–December 2024) — regulator page: https://www.oaic.gov.au/privacy/notifiable-data-breaches/notifiable-data-breaches-publications
...
- OAIC media release, Medibank civil-penalty proceedings (5 Jun 2024): https://www.oaic.gov.au/news/media-centre/oaic-takes-civil-penalty-action-against-medibank
...
- Crimes (Amount of a Penalty Unit) Instrument 2026 (F2026N00424), s 5 — legal text setting the penalty unit at A$364 for conduct from 1 July 2026: https://www.legislation.gov.au/F2026N00424/asmade/text
- Regulatory Powers (Standard Provisions) Act 2014, s 82 — legal text (civil penalty orders and the body-corporate multiplier): https://www.legislation.gov.au/C2014A00093/latest/text
- Not reachable when checked: Attorney-General's Department privacy and Privacy Act Review pages (ag.gov.au, connection timed out). The reported government intention to introduce a tranche-2 bill in 2026 rests on law-firm commentary — a secondary source — and is not confirmed by any official page cited here.
