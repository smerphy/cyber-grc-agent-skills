...
| Nov 2025 | Commission **Digital Omnibus** proposal: a single-entry point for incident reporting run by ENISA and modelled on the CRA platform; first stage covers NIS2, GDPR, DORA, CER and eIDAS (CRA reporting itself unchanged); legislative process ongoing as of September 2026 |
...
| 27 Jul 2026 | Commission publishes first (non-binding) CRA guidance under Art. 26: scope incl. remote data processing and FOSS, substantial modification, support periods, reporting and risk assessment; 67 worked examples; FAQ maintained alongside |
| 11 Sep 2026 | **Art. 14 reporting obligations apply; ENISA Single Reporting Platform live** (initial operating capability) |
| Q3–Q4 2026 (planned) | First harmonised-standard deliverables; delegated act on presumption of conformity via the EUCC Common Criteria scheme (Commission implementation roadmap). No CRA harmonised standard references had been published in the OJ as of mid-September 2026 (secondary trackers — verify against the OJ before relying on Art. 27) |
| 11 Dec 2026 | Commission milestone: sufficient notified bodies across Member States |
| 11 Dec 2027 | **Full application**; RED cybersecurity delegated act repealed; OSS steward reporting begins; products placed on the market earlier are caught only on substantial modification |
...
Pending or evolving as of September 2026: harmonised standards under M/606 (still in drafting and public enquiry), the Art. 8(1) delegated act mandating certification for critical products, the Art. 27(9) delegated act listing usable certification schemes, any Art. 13(24) SBOM-format implementing act, and the Digital Omnibus. Verify each before quoting it as law.
...
- European Commission, press release and library entry on the 27 July 2026 CRA guidance — regulator guidance: https://digital-strategy.ec.europa.eu/en/library/commission-publishes-new-guidance-support-timely-cyber-resilience-act-implementation (the guidance document itself was not fetched for this pack)
- European Commission, Digital Package / Digital Omnibus questions and answers (single-entry point for incident reporting) — regulator guidance: https://digital-strategy.ec.europa.eu/en/faqs/digital-package
...
- Statement that no CRA harmonised standard is yet cited in the OJ rests on secondary trackers (e.g. craevidence.com, cyberresilienceact.eu) as of August–September 2026, not on an official list — verify.
