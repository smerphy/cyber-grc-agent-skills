...
| Entry into force | 7 November 2024 — the twentieth day after OJ publication on 18 October 2024 (Art. 16); repeals Implementing Regulation (EU) 2018/151, the NIS1 digital-service-provider act (Art. 15) |
...
| Pending change | Commission proposal COM(2026) 13, procedure 2026/0012 (COD), of 20 January 2026 for targeted NIS2 amendments — not adopted; still in the ordinary legislative procedure as of September 2026 (verify) |
...
| 11–13 | Online marketplaces, online search engines, social networking platforms | Completely unavailable for > 5% or > 1 million EU users (whichever smaller); limited availability affecting > 5% / > 1 million users; malicious data compromise; data compromise affecting > 5% / > 1 million users |
...
| Belgium | Transposed (Commission tracker, 7 July 2025) | CCB's CyberFundamentals (CyFun) framework — three assurance levels (Basic, Important, Essential) selected by a maturity tool, built on NIST CSF v1.1 and moving to v2.0 — is the national reference scheme; ccb.belgium.be blocks scripted access, so the CyFun detail here comes from the Irish NCSC scheme co-owner page |
| Ireland | National Cyber Security Bill not enacted; General Scheme published September 2024; registration and incident portals not yet open; referred to the CJEU 8 July 2026 | Draft Risk Management Measures guidance and CyFun adoption announced 24 June 2025; Ireland is a CyFun scheme co-owner and recommends it as a voluntary route, alongside ISO 27001 and 62443 |
...
| Malta | "Not yet transposed" on the Commission tracker (8 July 2025); not among the 19 reasoned-opinion states | Verify current status |
...
- Supervision timing lags transposition: BSIG § 61(3) lets the BSI order evidence from other essential entities at the earliest three years after the BSIG entered into force, and from approved hospitals at the earliest five years; § 39(1) sets the KRITIS audit cycle; Italy phases incident reporting (January 2026) and baseline measures (October 2026). Early years are dominated by registration enforcement rather than audits.
...
| 26 June 2025 | ENISA NIS2 Technical Implementation Guidance published (mapping table v1.2), alongside "Cybersecurity roles and skills for NIS2 Essential and Important Entities" |
| 6 December 2025 | Germany's BSIG (NIS2 transposition) in force |
| 20 January 2026 | Commission cybersecurity package: COM(2026) 13 / 2026/0012 (COD) proposes targeted NIS2 amendments (simplified jurisdiction rules, streamlined ransomware data collection, cross-border supervision with a reinforced ENISA coordinating role; complements the Digital Omnibus single-entry point for incident reporting; amending Annexes I and II; the Commission states it will ease compliance for 28,700 companies, including 6,200 micro and small enterprises) — under negotiation (verify) |
...
- **GDPR** ([gdpr.md](gdpr.md)): a data-compromise trigger under Arts. 5–14 of 2024/2690 will usually also be a personal-data breach; the 72-hour GDPR clock runs to a different authority.
