...
| Structure | PDPA: data protection obligations in Parts 3–6B (including Part 6A breach notification) and enforcement provisions at ss. 48I–48O. Cybersecurity Act: Parts 3–3D (regulated systems and entities), Part 4 (CSA response powers), Part 5 (licensing), s. 35A codes of practice. MAS: binding Notices (hard clocks and minimum controls) layered under non-binding Guidelines (best practice) |
...
| Certifiable? | No statutory certification for PDPA. CSA Cyber Essentials and Cyber Trust marks are voluntary certifications, but CCoP 2026 requires CII owners to hold Cyber Trust Mark Advocate (Tier 5) or equivalent |
...
| Third-party-owned CII (Part 3A, s. 16A) | An essential-service provider is designated as responsible where a system it depends on (in or outside Singapore) meets the CII test but is not owned by the provider; duties include ensuring the system conforms to prescribed standards (s. 16F), incident reporting (s. 16I, 72-hour prescribed period) and notifying material changes to the legally binding commitment with the owner (s. 16K) | Regulations S 490/2026 in operation 13 Jul 2026 |
...
| Regs S 519/2018 r. 5 Reporting clock | Initial notification within **2 hours** of becoming aware; supplementary details (cause, impact, remediation) within **72 hours**; final incident report within **30 days** of the supplementary submission. Re-triggered 2h/72h/30d cycle where the incident becomes publicly observable or is found to exploit a zero-day vulnerability |
...
| Part 3B STCC (s. 17F) | Same reporting structure as CII, including supplier systems; S 680/2025 sets a 2-hour initial report |
...
- Compliance timeline for existing CII owners: new clauses (board accountability 3.1.4–3.1.5, senior management 3.2, asset management 4.1.2–4.1.4, monitoring 6.2.4, exercises 7.3, section 12) by **29 July 2027**; Cyber Trust Mark certification (3.3) by **31 December 2027**.
...
| Notice 658 (banks) / Notice 1121 (merchant banks), dated 11 Dec 2023, effective 11 Dec 2024 | Requirements on outsourced relevant services, focused on material services and services involving disclosure of customer information; outsourcing register in MAS template v1.1 submitted from 11 Dec 2024 |
| Guidelines on Outsourcing (Banks) and (FIs other than Banks), effective 11 Dec 2024 | Replace the 2016/2018 Guidelines on Outsourcing (cancelled); supervisory expectations for outsourcing risk management, read with Notice 658/1121 for banks |
...
| 1 Feb 2021 | PDPA (Amendment) Act 2020 main commencement (all but six sections): mandatory breach notification (Part 6A) and the Notification of Data Breaches Regulations 2021 |
...
| 31 Oct 2025 | Cybersecurity (Amendment) Act 2024 main commencement (Parts 3, 3A, 3B, virtual systems, supply-chain reporting, s. 35A); S 678/2025 and S 680/2025 regulations in operation |
| 1 Feb 2026 | MAS incident reports via MAS-Tx with revised template (Circular MAS/TCRS/2025/08) |
| 6 Mar – 20 Apr 2026 | MAS consultations on proposed Guidelines on Third-Party Risk Management (P004-2026) and updated Operational Risk Management Guidelines — closed, final guidelines pending |
...
| Pending | Commencement of Parts 3C (ESCI) and 3D (major FDI providers) and the Third Schedule (verify); PDPC guidance updates |
...
9. **Horizon-scan** the commencement of Parts 3C/3D, MAS third-party risk guidelines and CCoP releases. See [../../skills/regulatory-horizon-scanning/SKILL.md](../../skills/regulatory-horizon-scanning/SKILL.md).
...
- Cybersecurity (Provider-Owned Critical Information Infrastructure) Regulations 2018 (S 519/2018, as amended): https://sso.agc.gov.sg/SL/CA2018-S519-2018 (legal text)
...
- Not reachable during review: PDPC Guide on Managing and Notifying Data Breaches (pdpc.gov.sg) — the 30-day assessment expectation is therefore marked (verify) above.
