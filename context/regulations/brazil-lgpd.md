...
| Sensitive data (Art. 11) | Specific, highlighted consent, or one of seven consent-free grounds (legal obligation; public-policy sharing; research; exercise of rights; life/physical safety; health protection; fraud prevention and security in identification/authentication of registrations in electronic systems). Sharing health data between controllers for economic gain may be prohibited or regulated by the ANPD (§3 — on the 2025–2026 regulatory agenda) |
...
| Element | Requirement |
|---|---|
| Trigger | A confirmed adverse event affecting confidentiality, integrity, availability or authenticity of personal data that **may cause relevant risk or damage** to data subjects: significant effect on interests/fundamental rights **and** at least one of — sensitive data; data of children, adolescents or the elderly; financial data; authentication credentials; data under legal, judicial or professional secrecy; large-scale data (Art. 5). A mere vulnerability is not an incident |
...
**Practice:** the ANPD describes its model as responsive regulation — monitoring, guidance and preventive measures first, sanctions when a regulated entity does not cooperate; it states that every sanctioning process to date was opened because of a non-collaborative posture. Requerimentos (complaints and petitions) rose from 768 (2021) to 4,029 (2024). Concluded sanctioning processes published by the ANPD include Telekall Infoservices (non-compliance with an ANPD order), the Rio de Janeiro Botanical Garden institute, the Federal District Education Secretariat, the INSS, the Ministry of Health and a state social-development secretariat (SDSCJ) — mostly for failure to communicate incidents, failure to produce a RIPD or records, or failure to answer the regulator. Ongoing cases include the Ministry of Health, ByteDance/TikTok (children's best interest) and RaiaDrogasil (profiling on sensitive data for monetised advertising); a 2025 monitoring sweep targets 20 companies for missing DPO designation or contact channels. Fine amounts are published on the federal Transparency Portal (sanctions panel, filter "Agência Nacional de Proteção de Dados") rather than on the ANPD site — check there for current figures.
...
| 2022 | MP 1.124/2022 → Law 14.460/2022 — ANPD becomes a special-regime autarchy |
...
| 25 Feb 2026 | Law 15.352/2026 — ANPD becomes a regulatory agency; ECA Digital commencement fixed at 17 Mar 2026 |
| 17–18 Mar 2026 | ECA Digital in force; Decree 12.880/2026 details it; ANPD preliminary age-assurance guidance published; monitoring of app stores and operating systems begins, with a second monitoring phase planned from August 2026 |

**Pending (regulatory agenda 2025–2026 as amended Dec 2025):** Phase 1 — data-subject rights (Arts. 9, 18, 19, 20), RIPD, public-sector data sharing, biometric data, minimum security standards, artificial intelligence, high-risk processing, religious organisations, anonymisation/pseudonymisation; Phase 2 — national data-protection policy guidelines, data aggregators/scraping, health data, ECA Digital scope guidance, revision of Res. 1/2021 and 4/2023 for ECA Digital enforcement, age-assurance mechanisms; Phase 3 — rule-making procedure (Portaria 16/2021); Phase 4 — good-practice rules, consent, credit-protection basis. Expect the sanctions and incident regulations to be reissued once the ECA Digital revisions land; track via [../../skills/regulatory-horizon-scanning/SKILL.md](../../skills/regulatory-horizon-scanning/SKILL.md).
...
- **GDPR:** structurally parallel (bases, rights, DPO, records, transfers) but with material differences: ten legal bases including credit protection; a 3-business-day incident clock to both regulator and data subjects versus 72 hours to the authority only; a 15-day access deadline versus one month; a R$ 50 million per-infraction fine cap versus 4% of worldwide turnover; no mandatory DPIA trigger yet. Since January 2026 both directions are covered by adequacy, so EU–Brazil intra-group flows no longer need SCCs — but the adequacy decisions each exclude law-enforcement/national-security transfers. See [gdpr.md](gdpr.md).
...
- Lei nº 13.853/2019 — Planalto: https://www.planalto.gov.br/ccivil_03/_ato2019-2022/2019/lei/l13853.htm (legal text)
...
- Res. CD/ANPD 4/2023 (dosimetry) — Ministry of Justice repository: https://dspace.mj.gov.br/bitstream/1/9179/2/RES_ANPD_2023_4.html (regulation; appendices not rendered in this copy)
- Res. CD/ANPD 15/2024 (incident communication) — DOU text as republished by the Mato Grosso do Sul state LGPD portal: https://www.lgpd.ms.gov.br/wp-content/uploads/2024/05/REGULAMENTO-DE-COMUNICACAO-DE-INCIDENTE-DE-SEGURANCA-ABRIL-2024-ANPD-.pdf (regulation, mirror); ANPD incident page and FAQ: https://www.gov.br/anpd/pt-br/assuntos/comunicacao-de-incidentes-de-seguranca-cis (regulator guidance)
...
- Res. CD/ANPD 32/2026 (EU adequacy, English version) — https://www.gov.br/anpd/pt-br/centrais-de-conteudo/outros-documentos-e-publicacoes-institucionais/resolucao-no-32-decisao-de-adequacao-uniao-europeia-em-lingua-inglesa.pdf/@@display-file/file (regulation)
- Commission Implementing Decision (EU) 2026/179 (Brazil adequacy) — CELEX 32026D0179 (legal text)
...
- ANPD ECA Digital page — https://www.gov.br/anpd/pt-br/assuntos/eca-digital (regulator guidance)
