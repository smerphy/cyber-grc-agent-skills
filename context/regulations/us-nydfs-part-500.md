...
| Regulator | New York State Department of Financial Services (DFS / NYDFS); the Superintendent enforces via examination and consent orders |
...
| Penalties | No fixed ceiling in Part 500; civil penalties assessed under the Banking, Insurance and Financial Services Laws using the §500.20(c) factors. Settlements to date range from $250,000 to $30 million (the latter combined with other violations) |
...
Part 500 is New York's prescriptive cybersecurity regulation for DFS-licensed financial services companies. It requires every DFS-licensed entity to run a risk-based cybersecurity program with named minimum controls, a designated CISO, board-level oversight, regulator notification of incidents, and an annual executive-signed compliance filing. The original rule took effect on 1 March 2017 (§500.21(a)); a First Amendment in 2020 moved the annual filing date from 15 February to 15 April (verify — the current text simply states 15 April in §500.17(b)).
...
| 11 Aug 2026 | Cyber threat alert (N-central vulnerability) | Example of DFS's practice of issuing product-specific vulnerability alerts that examiners expect entities to have actioned under §500.5(b) |
...
| 2020 | First Amendment — annual filing date moved to 15 April (verify) |
| 9 Nov 2022 / 28 Jun 2023 | Proposed and revised proposed Second Amendment published in the State Register |
...
| 15 Apr 2026 | First annual notice covering a full calendar year (2025) in which every amended requirement was in force |
| 2026 status | No Third Amendment proposed or adopted as of 18 September 2026 (searches found none); DFS activity in 2026 has been guidance (May and September letters) and enforcement, not rulemaking. Watch the DFS Cybersecurity Resource Center and State Register |
...
8. **Third-party program** aligned to §500.11: provider inventory and risk tiering, minimum practices, MFA/encryption/notice contract clauses, periodic reassessment; extend to AI vendors per the October 2024 letter. See [../../skills/third-party-risk-assessment/SKILL.md](../../skills/third-party-risk-assessment/SKILL.md).
...
- **NAIC Insurance Data Security Model Law:** widely described as derived from Part 500 (verify against the current model text); insurers licensed in multiple states should treat Part 500 as the superset and map state variants (notice clocks, exemption thresholds) against it.
...
- **State breach laws / New York SHIELD Act:** consumer-notice statutes drive limb (1) of the DFS incident definition and the §500.20(c)(9) penalty factor on timely consumer disclosure. See [us-state-privacy.md](us-state-privacy.md).
...
- DFS press releases: pr202208021 (Robinhood Crypto), pr202305251 (OneMain), pr20250814 (Healthplex), pr20251014 (auto insurers), pr20260430 (Delta Dental), pr20260805 (Order Express) under https://www.dfs.ny.gov/reports_and_publications/press_releases/
- Not fetched: the unofficial NYCRR compilation at govt.westlaw.com/nycrr returned only the title index; the First Amendment (2020) date rests on secondary summaries and is marked (verify) above.
