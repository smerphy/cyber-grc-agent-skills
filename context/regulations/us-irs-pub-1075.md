...
| Who is covered | Federal, state and local agencies (and other recipients listed in § 6103(p)(4)) that receive FTI under a § 6103 exception, plus their contractors, sub-contractors, consolidated data centers and state consolidated IT organizations |
| Structure | Section 1.0 FTI, reviews and reporting; Section 2.0 physical security keyed to § 6103(p)(4)(A)–(F) (2.A–2.F); Section 3.0 cybersecurity and technology-specific rules; Section 4.0 NIST SP 800-53 Rev. 5 control catalog (20 families, 4.1–4.20); Exhibits 1–9 (statute, CFR, sanctions, 45-day procedures, contract language, banners, retention) |
...
| Contractors and agents | In scope through the agency: § 6103(p)(9) forbids disclosure to any contractor or agent unless the agency has safeguard requirements in effect, conducts an **on-site review every 3 years** (or mid-point for shorter contracts), reports the findings in its § 6103(p)(4)(E) report, and certifies compliance annually (name, address, contract description, duration). Pub 1075 records this as effective 31 December 2022 |
...
| 45-day notifications (Section 2.E.6, Table 6) | Notify safeguardreports@irs.gov at least **45 days** before: implementing cloud computing (notify); disclosing FTI to a contractor (notify); contractor re-disclosure to a sub-contractor (notify **and obtain approval**); using FTI in tax modeling (approval, valid up to 3 years); using live FTI in a pre-production/test environment via a Data Testing Request (approval). Noting a change in the SSR does not satisfy the notification duty |
| Contractor notification letter (Exhibit 6) | On agency letterhead over the head of agency's signature: POC, contractor name/address, contract number, dates and period, service type, headcount, program supported, FTI to be disclosed, work and phasing, oversight procedures, work locations, sub-contractor details, and certification that all personnel and systems are within the US |
...
| Internal inspections (2.D.3) | Agency inspections of all FTI sites on a three-year cycle plan, performed by staff outside the inspected function, reported with the SSR |
...
| Encryption (SC-8, SC-13, 2.E.3) | Latest FIPS 140-validated modules for all FTI in transit (WAN and LAN, file transfers, app-to-database), email containing FTI, wireless, mobile media and remote access; SHA-1 prohibited for digital signatures. At rest, encryption is required in cloud and on mobile media; a dedicated, SCSEM-configured system behind two physical barriers is exempt at rest |
| Identity (IA-2, IA-5) | Multi-factor authentication at NIST SP 800-63 Authenticator Assurance Level 2; updated password complexity; accounts disabled within 24 hours of termination, transfer or need-to-know change; user accounts reviewed annually, privileged accounts semi-annually |
...
| Jun–Sep 2026 | IRS Safeguards pages (program page 28 Jun 2026; incident page 30 Jul 2026; cloud page 4 Aug 2026; SSR and contractor pages 18 Sep 2026) reviewed and still cite Rev. 11-2021 — no successor edition located as of 18 September 2026 |
| Watch items | Pub 1075 Section 4.0 maps to SP 800-53 Rev. 5 as published in 2020; later NIST patch releases are not reflected (verify the current release against the [nist-800-53](../frameworks/nist-800-53.md) pack). Section 3.3.1 still describes authorization by "the Joint Advisory Board (JAB) or a Federal Agency" — confirm the current FedRAMP authorization pathway before relying on that wording (verify). Fetched IRS guidance references FedRAMP only; no StateRAMP equivalence is stated |
...
6. **Map Section 4.0 to your control set.** Treat Pub 1075 Section 4.0 as an SP 800-53 Rev. 5 overlay with IRS-defined parameters (AAL2 MFA, 7-year audit retention, 24-hour account disablement, 3-year penetration testing); test against the current SCSEMs. See [control-mapping](../../skills/control-mapping/SKILL.md), [control-testing](../../skills/control-testing/SKILL.md) and [framework-crosswalk](../crosswalks/framework-crosswalk.md).
7. **Close the people controls.** Background investigations before access and 5-year reinvestigation, annual disclosure-awareness training with signed certifications retained 5 years, quarterly awareness updates, and personnel sanction processes; keep evidence review-ready.
...
- **State privacy and breach laws.** Pub 1075 governs notice to the IRS and TIGTA; individual notification is left to agency policy and state statute, which often carry their own deadlines. See [us-state-privacy](us-state-privacy.md).
...
- IRS, Encryption requirements of IRS Publication 1075 (reviewed 2 Sep 2026) — regulator guidance: https://www.irs.gov/privacy-disclosure/encryption-requirements-of-irs-publication-1075
...
- 26 U.S.C. § 6103 — legal text (LII mirror of the U.S. Code): https://www.law.cornell.edu/uscode/text/26/6103
- 26 U.S.C. § 7213 — legal text: https://www.law.cornell.edu/uscode/text/26/7213
- 26 U.S.C. § 7213A — legal text: https://www.law.cornell.edu/uscode/text/26/7213A
- 26 U.S.C. § 7431 — legal text: https://www.law.cornell.edu/uscode/text/26/7431
- 26 CFR 301.6103(p)(7)-1 — cited via Pub 1075 Exhibit 3 and the IRS incident page; the eCFR text itself was not fetched.
