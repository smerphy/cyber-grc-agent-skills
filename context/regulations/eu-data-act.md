...
| Status and key dates | In force 11 January 2024; applies from 12 September 2025; Art. 3(1) access-by-design duty for connected products placed on the market after 12 September 2026; switching charges abolished from 12 January 2027; Chapter IV reaches certain legacy contracts from 12 September 2027 |
...
| Relationship to neighbours | Complements GDPR (which prevails on conflict, Art. 1(5)); adds cloud-switching obligations to Regulation (EU) 2018/1807; sits alongside the Data Governance Act; Digital Omnibus proposal (November 2025) would fold DGA, Open Data Directive and 2018/1807 into it |
...
| 26 | Information | Switching procedures, methods, formats, known limitations; a public online register of data structures, formats and interoperability specifications |
...
| 12 Sep 2025 | General application; Chapter IV applies to new contracts; deadline for Member States to notify penalty rules; Art. 41 model terms due |
| 19 Nov 2025 | Commission Recommendation on non-binding Model Contractual Terms (data sharing) and Standard Contractual Clauses (cloud contracts) published; Digital Omnibus proposal tabled the same day |
| 16 Dec 2025 | Commission Data Act Legal Helpdesk launched |
| 30 May 2026 | German DADG in force; Bundesnetzagentur competent |
| 12 Sep 2026 | Art. 3(1) access-by-design duty applies to connected products and related services placed on the market after this date |
...
**Digital Omnibus (pending, as of September 2026).** The Commission's Digital Omnibus Regulation proposal of 19 November 2025 would: broaden the trade-secret refusal ground in Arts. 4(8) and 5(11) to cover substantial risk of leakage to third countries; narrow Chapter V to public emergencies via a new Art. 15a and allow micro/small enterprises compensation; delete Art. 36 on smart contracts; give a lighter Chapter VI regime to custom-made services and to SME and small mid-cap providers (described on the Commission's Digital Package FAQ as companies with "less than 749 employees"; verify the threshold in the final text) for contracts concluded on or before 12 September 2025, and state that proportionate early-termination penalties in fixed-term contracts are permitted; and repeal and merge Regulation (EU) 2018/1807, the Data Governance Act and the Open Data Directive into the Data Act. The EDPB and EDPS issued Joint Opinion 2/2026 in February 2026. Council compromise texts were circulating and Parliament committee drafts were under discussion in mid-2026; no adoption had been reported in the sources reviewed for this pack. Treat all Omnibus changes as proposals until published in the Official Journal.

Secondary and soft law to track: delegated act on monitoring switching charges (Art. 29(7)); implementing acts listing interoperability standards in the central Union repository (Art. 35(8)); Commission guidelines on reasonable compensation (Art. 9(5)); the "European Trusted Data Framework" standardisation request under Art. 33; Commission guidance on vehicle data; certified dispute-settlement bodies list (Art. 10(6)).
...
4. **Engineer access by design before 12 September 2026** for new connected products: data catalogue with metadata, secure user-facing retrieval API, real-time streaming where feasible, verification that collects no more than necessary, and access logs retained only for security and maintenance.
...
- Regulation (EU) 2023/2854 (Data Act), official text via the Publications Office / EUR-Lex, CELEX 32023R2854 — legal text: https://eur-lex.europa.eu/eli/reg/2023/2854/oj
...
- European Commission, Recommendation on non-binding Model Contractual Terms and Standard Contractual Clauses for cloud computing contracts, 19 November 2025 — regulator guidance: https://digital-strategy.ec.europa.eu/en/library/draft-recommendation-non-binding-model-contractual-terms-data-access-and-use-and-non-binding
...
- European Commission, Digital Omnibus Regulation Proposal, 19 November 2025 — publisher page: https://digital-strategy.ec.europa.eu/en/library/digital-omnibus-regulation-proposal; Digital Package FAQ: https://digital-strategy.ec.europa.eu/en/faqs/digital-package
- EDPB-EDPS Joint Opinion 2/2026 on the Digital Omnibus proposal, February 2026 — regulator opinion: https://www.edpb.europa.eu/system/files/2026-02/edpb_edps_jointopinion_202602_digitalomnibus_en.pdf
...
- Bird & Bird, "EU Digital Omnibus package: major changes to the Data Act proposed" (November 2025) — secondary source used only for the article-level detail of the Omnibus proposal: https://www.twobirds.com/en/insights/2025/eu-digital-omnibus-package-major-changes-to-the-data-act-proposed
- Not fetched (blocked or empty): European Parliament Legislative Train page on the Digital Omnibus; law-firm status notes on the mid-2026 Council compromise text were consulted only through search summaries.
