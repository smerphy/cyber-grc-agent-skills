...
| SEBI CSCRF | All SEBI-regulated entities in five graded categories: MIIs, Qualified, Mid-size, Small-size, Self-certification REs, set each financial year on prior-year thresholds (e.g., AIF AUM bands starting below INR 100 crore) | Vault managers, REITs/InvITs, qualified DPs and RTAs under 10,000 folios are excluded from compliance submission |
...
|---|---|---|---|
| RBI Cyber Security Framework in Banks (RBI/2015-16/418, 2 June 2016; scheduled commercial banks excl. RRBs) | Board-approved cyber-security policy distinct from IT/IS policy; Cyber Crisis Management Plan; board and top-management awareness | SOC with continuous surveillance; Annex 1 baseline controls; Annex 2 SOC configuration; gap assessment submitted by CISO | Report all unusual cyber incidents (successful or attempted) promptly to RBI in the Annex 3 format; share with IB-CART. Annex 3 reporting window commonly cited as 2–6 hours (verify — annex not retrievable) |
...
| 20 Aug 2024 | SEBI CSCRF issued; adoption 1 Jan 2025 (existing-circular REs) and 1 April 2025 (others); Market SOC by 1 Jan 2025; extensions granted in 2025 (verify) |
| 3 Jan 2025 | Draft DPDP Rules published (G.S.R. 02(E)), 45-day consultation |
| 13 Nov 2025 | DPDP Rules 2025 notified (G.S.R. 846(E)); rules 1, 2, 17–21 (Board appointment, procedure, digital office, staff) in force; corresponding Act provisions commenced by separate notification (verify S.O. numbers and current Board constitution status) |
...
Pending as of September 2026: notification of Significant Data Fiduciaries, blacklisted transfer countries under s.16, rule-15 transfer orders, and the SDF localisation list (rule 13(4)). Track these via [../../skills/regulatory-horizon-scanning/SKILL.md](../../skills/regulatory-horizon-scanning/SKILL.md).
...
- SEBI CSCRF circular and framework PDF, 20 Aug 2024 (regulator circular): https://www.sebi.gov.in/legal/circulars/aug-2024/cybersecurity-and-cyber-resilience-framework-cscrf-for-sebi-regulated-entities-res-_85964.html
