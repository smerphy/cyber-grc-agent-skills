...
| Cloud service providers | Section 1.3: external service providers include CSPs; the publication does not replace FedRAMP-style federal cloud guidance | Treat CSPs as suppliers under SR/SA controls; CSP-specific authorization remains separate |
...
Scope covers the whole system life cycle (design, development, distribution, deployment, acquisition, maintenance, destruction) for ICT and OT products and services. NIST recommends the guidance for systems at all FIPS 199 impact levels, with agencies free to prioritise higher-impact systems or specific components.
...
- Appendix D.4's risk-assessment template follows five analyses: information gathering and scoping (Table 26, the SCRM Assessment Scoping Questionnaire — a fillable version was released 2 December 2025), threat, vulnerability, impact, risk response.
...
| 26 Aug 2021 (effective 27 Sep 2021) | FASC final rule, 41 CFR Parts 201 and 201-1: FASC operation, information sharing, exclusion/removal order procedures |
...
| 8 Jul 2026 | SP 1326 final; C-SCRM fact sheet refreshed |
| Sep 2026 | Status: Rev. 1 upd1 is current. No Rev. 2 draft listed on the NIST C-SCRM project news page. Watch the EO 14028 online Appendix F, the final SSDF 1.2, and FASC order activity via [regulatory-horizon-scanning](../../skills/regulatory-horizon-scanning/SKILL.md) |
...
- **FASCSA and FASC rule:** § 1323 gives the FASC power to recommend exclusion and removal orders (sources get 30 days to respond to a notice); § 4713 lets agency heads take covered procurement actions with notification and confidentiality rules; § 1326 puts the assessment duty on each agency consistent with NIST guidance. Appendix E is the bridge between agency assessments and FASC action.
...
- **ISO/IEC 27001:2022:** Annex A supplier-relationship controls (A.5.19–A.5.23) and ISO/IEC 27036 (SP 800-161 cites 27036-2:2014, "Information security for supplier relationships — Part 2: Requirements"; other parts and current editions not verified here — ISO text is paywalled) cover the same ground with less operational detail; ISO 28000 (cited as ISO 28000:2007 in Appendix D; current edition (verify)) addresses security management for the physical supply chain. See [iso-27001-2022.md](iso-27001-2022.md).
- **CISA ICT SCRM Task Force:** public-private body whose Threat Scenarios Report v3 (August 2021) is cited in Appendix C; its other deliverables (vendor SCRM template, HBOM, SBOM material) could not be fetched for this pack (verify).
...
- NIST SP 800-18 Rev. 2 and SP 1326 publication pages: https://csrc.nist.gov/pubs/sp/800/18/r2/final ; https://csrc.nist.gov/pubs/sp/1326/final
...
- 41 U.S.C. §§ 1323, 1326, 4713 (legal text, via Cornell LII): https://www.law.cornell.edu/uscode/text/41/1323 ; /1326 ; /4713
- FASC final rule, 86 FR 47582 (26 Aug 2021), 41 CFR Parts 201 and 201-1 (legal text, govinfo PDF): https://www.govinfo.gov/content/pkg/FR-2021-08-26/pdf/2021-17532.pdf
...
- EO 14306 (6 June 2025), White House text: https://www.whitehouse.gov/presidential-actions/2025/06/sustaining-select-efforts-to-strengthen-the-nations-cybersecurity-and-amending-executive-order-13694-and-executive-order-14144/
- NIS2, Directive (EU) 2022/2555 Arts. 21–22 (legal text, Publications Office CELEX 32022L2555)
- Not fetched (blocked): CISA ICT SCRM Task Force pages (cisa.gov, 403); ISO/IEC 27036 catalogue and Online Browsing Platform (iso.org, 403); eCFR 41 CFR Part 201 (404 — FASC rule taken from the govinfo Federal Register PDF instead)
