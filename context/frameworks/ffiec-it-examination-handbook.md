...
| Status | Living series; booklets are revised individually. The series replaced the 1996 FFIEC Information Systems Examination Handbook, which was retired when the last two booklets were issued in November 2004 |
...
| Who is covered | FDIC-insured depository institutions supervised by an FFIEC member agency, plus the technology service providers examined under the Bank Service Company Act |
...
| Live 2026 issue | Interagency third-party risk management guidance is being rewritten: proposed guidance at 91 FR 58536 (15 September 2026), comments close 16 November 2026 |
...
Its authority is indirect but real. The Handbook interprets binding requirements — principally the Interagency Guidelines Establishing Information Security Standards issued under Gramm-Leach-Bliley Act §501(b) (12 CFR part 30 App. B for OCC-supervised banks, 12 CFR part 364 App. B for FDIC-supervised banks) and the Bank Service Company Act's examination authority over service providers. Because examiners rate against URSIT and cite Handbook expectations in findings, a Handbook gap becomes a Matter Requiring Attention long before it becomes a rule violation.

Two structural features matter for GRC planning. First, booklets age at very different rates: the Information Security and Management booklets predate NIST CSF 2.0 and mainstream cloud adoption, while Architecture, Infrastructure, and Operations (2021) and Development, Acquisition, and Maintenance (2024) explicitly address cloud, microservices, zero trust, AI and machine learning. Second, much current supervisory expectation now arrives *outside* the Handbook — as interagency statements, agency-specific examination programs and rules — so a Handbook-only reading of the regime is incomplete.
...
|---|---|---|
| Architecture, Infrastructure, and Operations (AIO) | June 2021 | Replaced the Operations booklet (July 2004); covers cloud computing, microservices, zero trust architecture, AI/ML and IoT |
| Development, Acquisition, and Maintenance (DA&M) | August 2024 | Replaced Development and Acquisition (April 2004); governance of IT development, acquisition, maintenance and change control; issued with no new requirements |
| Business Continuity Management (BCM) | November 2019 | Successor to the Business Continuity Planning booklet, whose Appendix J on third-party resilience was updated in February 2015 |
| Management | November 2015 | IT governance, risk management, board and senior management responsibilities |
| Information Security | Edition date (verify) — commonly cited as September 2016 | The security-program booklet examiners cite alongside the GLBA Security Guidelines |
| Supervision of Technology Service Providers (TSP) | Revised 2012 | Replaced the March 2003 edition; describes the interagency risk-based TSP supervision program |
| Outsourcing Technology Services | Updated 2012 | Original edition 2004 (verify); overlaps heavily with, and is being overtaken by, interagency third-party guidance |
| Audit | 2003 issuance; later revision (verify) | Feeds the URSIT Audit component |
| E-Banking | 2003 | Issued in the same series as the IT Audit booklet (October 2003) |
| Retail Payment Systems | February 2010 update | A Mobile Financial Services appendix was added in 2016 |
| Wholesale Payment Systems | 2004 | Interbank/intrabank payment, messaging and securities settlement |

Booklet titles and edition dates should be confirmed against the FFIEC's own Handbook site before being quoted in an audit deliverable; the series is revised booklet-by-booklet without a version number for the whole Handbook.
...
| Cybersecurity Assessment Tool (CAT) | June 2015 – 31 August 2025 | Voluntary inherent-risk/maturity self-assessment; the agencies communicated the sunset on 5 September 2024 (FDIC FIL-61-2024) because the FFIEC chose not to update the tool for NIST CSF 2.0 and the CISA Cybersecurity Performance Goals |
...
| Third-Party Risk Management: A Guide for Community Banks | 3 May 2024 | Supplemental resource to the 2023 guidance |
| Joint Statement on Banks' Arrangements with Third Parties to Deliver Bank Deposit Products | 25 July 2024 | Bank-fintech deposit arrangements |
...
See the repository pack on US banking incident notification and third-party supervision for the notification rules in depth.
...
| 2003–2004 | Modern booklet series issued; 1996 IS Examination Handbook retired with the Operations and Wholesale Payment Systems booklets (10 November 2004) |
...
| 5 September 2024 | CAT sunset communicated to supervised institutions (FDIC FIL-61-2024) |
| 31 August 2025 | CAT removed from the FFIEC website |
| 28 November 2025 | Interagency request for information on community banks' engagement with core service providers (90 FR 54882) |
...
| 11–15 September 2026 | Agencies (OCC, Federal Reserve, FDIC and, for the first time, NCUA) propose third-party risk management guidance that would **rescind and replace** the 2023 guidance and its supplemental resources — 91 FR 58536, comments close 16 November 2026 — issued with a Joint Statement on Community Banks' Engagement with Core Service Providers |

As of September 2026 the proposed third-party guidance is not final; the 2023 guidance, the community bank guide and the bank-fintech statement remain in effect until any final replacement is issued.
...
4. **Re-baseline third-party programs against the September 2026 proposal** — tailoring to assessed risk is its central theme; comment or prepare to re-tier before any final guidance lands.
...
- **CRI Profile v2.2** is the financial-sector overlay most commonly used in examinations and third-party due diligence: NIST CSF 2.0-aligned, about 318 diagnostic statements, roughly 40 regulatory and standards mappings, and an impact tiering based on systemic impact rather than asset size.
...
- Regulator guidance — FDIC letters announcing booklets and examination procedures: FIL-60-2024 (DA&M), FIL-47-2021 (AIO), FIL-55-2021 (Authentication and Access), FIL-43-2016 and FIL-52-2023 (InTREx), FIL-119-2004 (series completion), FIL-58-2026 (2026 third-party proposal): https://www.fdic.gov/news/financial-institution-letters
...
- Regulator guidance — NCUA cybersecurity resources (Information Security Examination, ACET): https://ncua.gov/regulation-supervision/regulatory-compliance-resources/cybersecurity-resources
- Publisher page — Cyber Risk Institute, CRI Profile overview (v2.2): https://cyberriskinstitute.org/cri-profile-overview/
- Publisher site — FFIEC IT Handbook InfoBase, https://ithandbook.ffiec.gov — **could not be retrieved**; booklet editions above were confirmed from the member agencies' issuance letters instead
