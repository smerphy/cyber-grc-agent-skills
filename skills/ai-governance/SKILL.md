...
1. **Organizational footprint**: EU nexus (established in EU? placing AI systems on the EU market? outputs used in the EU?), sectors served, whether the org develops AI, buys it, or both. Other applicable AI rules — US state and local statutes such as the Colorado ADMT Act, Texas TRAIGA, the California CPPA automated-decision regulations and NYC Local Law 144 ([us-state-ai-laws.md](../../context/regulations/us-state-ai-laws.md)), UK automated-decision duties under UK GDPR ([uk-data-protection.md](../../context/regulations/uk-data-protection.md)), and sectoral model-risk guidance such as SR 11-7 for banks — route the applicability question through [../regulatory-applicability/SKILL.md](../regulatory-applicability/SKILL.md).
...
2. **Classify each system under the EU AI Act.** For each row determine:
   ...
   - **Decision point:** no EU nexus → skip AI Act obligations but keep the tiering as an internal risk-severity proxy; it is the de facto common language. Then test the rules that do bite: the state and local AI statutes in [us-state-ai-laws.md](../../context/regulations/us-state-ai-laws.md) (note that only some of them credit a recognized AI risk framework as a defence — check the pack per state) and the automated-decision provisions of the applicable privacy law.
...
- **AI-specific regimes:** [eu-ai-act.md](../../context/regulations/eu-ai-act.md) · [us-state-ai-laws.md](../../context/regulations/us-state-ai-laws.md)
- **AI management and risk frameworks:** [iso-42001-ai-management.md](../../context/frameworks/iso-42001-ai-management.md) · [nist-ai-rmf.md](../../context/frameworks/nist-ai-rmf.md) · [iso-31000-27005-risk-management.md](../../context/frameworks/iso-31000-27005-risk-management.md) · [iso-27001-2022.md](../../context/frameworks/iso-27001-2022.md)
- **Privacy law governing AI processing and automated decisions:** [gdpr.md](../../context/regulations/gdpr.md) · [uk-data-protection.md](../../context/regulations/uk-data-protection.md) · [us-state-privacy.md](../../context/regulations/us-state-privacy.md) · [us-biometric-privacy-laws.md](../../context/regulations/us-biometric-privacy-laws.md) · [china-pipl-dsl-csl.md](../../context/regulations/china-pipl-dsl-csl.md) · [south-korea-pipa.md](../../context/regulations/south-korea-pipa.md) · [brazil-lgpd.md](../../context/regulations/brazil-lgpd.md) · [canada-pipeda-law-25.md](../../context/regulations/canada-pipeda-law-25.md)
- **Regimes AI obligations sit on top of (security, product, sector):** [nis2.md](../../context/regulations/nis2.md) · [dora.md](../../context/regulations/dora.md) · [eu-cyber-resilience-act.md](../../context/regulations/eu-cyber-resilience-act.md) · [eu-product-security-red-machinery.md](../../context/regulations/eu-product-security-red-machinery.md) · [us-fda-medical-device-cybersecurity.md](../../context/regulations/us-fda-medical-device-cybersecurity.md) · [eu-ehds.md](../../context/regulations/eu-ehds.md)
...
- [../regulatory-applicability/SKILL.md](../regulatory-applicability/SKILL.md) — establishing which AI rules reach the organization
- [../incident-regulatory-reporting/SKILL.md](../incident-regulatory-reporting/SKILL.md) — serious-incident and breach reporting duties for AI systems
