...
- A US state privacy law data protection assessment is required (targeted advertising, sale of personal data, profiling with significant effects, sensitive data — see [../../context/regulations/us-state-privacy.md](../../context/regulations/us-state-privacy.md)).
...
3. **Assess necessity and proportionality** (Art. 35(7)(b)). For each purpose answer: Is the processing necessary to achieve it, or would a less intrusive means work? Is each data element needed (data minimization)? Is retention justified per element? Is the lawful basis valid and correctly matched (consent must be freely given — problematic for employees; legitimate interests requires the three-part test)? Are Arts. 13/14 transparency, data-subject rights handling, processor contracts (Art. 28), and transfer mechanisms in place? Record gaps as compliance findings distinct from risk findings.
...
- [../../context/regulations/gdpr.md](../../context/regulations/gdpr.md) — GDPR scope, lawful bases, Art. 35/36, transfers
- [../../context/regulations/us-state-privacy.md](../../context/regulations/us-state-privacy.md) — US state data protection assessment triggers
