...
- **SOC 2 Type II report** — strongest common evidence for SaaS. Type I only proves design at a point in time; treat it as a partial answer and ask when the Type II period ends. See [../../context/frameworks/soc2-tsc.md](../../context/frameworks/soc2-tsc.md). Where the service touches financial reporting, the relevant report is a SOC 1 / ISAE 3402 instead — [../../context/frameworks/soc1-isae3402-soc-reports.md](../../context/frameworks/soc1-isae3402-soc-reports.md) covers the differences and the restricted-use rules.
- **ISO/IEC 27001:2022 certificate** — verify: issuing certification body is accredited (check the accreditation mark), certificate is current (3-year cycle with surveillance audits), and the **scope statement covers the service you buy** — a certificate scoped to "corporate IT of HQ office" says nothing about the SaaS platform. Request the Statement of Applicability to see excluded controls. See [../../context/frameworks/iso-27001-2022.md](../../context/frameworks/iso-27001-2022.md); for cloud services, check whether the scope also carries the ISO/IEC 27017 / 27018 extension ([../../context/frameworks/iso-27017-27018-cloud.md](../../context/frameworks/iso-27017-27018-cloud.md)).
...
If personal data is processed, a DPA with GDPR Art. 28 processor terms is required — coordinate with [../dpia-privacy-assessment/SKILL.md](../dpia-privacy-assessment/SKILL.md) and [../../context/regulations/gdpr.md](../../context/regulations/gdpr.md). Financial-sector engagements may trigger DORA ICT third-party contractual requirements: [../../context/regulations/dora.md](../../context/regulations/dora.md), with the contractual, sub-outsourcing and register-of-information detail in [../../context/regulations/eu-dora-technical-standards.md](../../context/regulations/eu-dora-technical-standards.md).
...
- Supply chain and software suppliers: [../../context/frameworks/nist-800-161-cscrm.md](../../context/frameworks/nist-800-161-cscrm.md) — C-SCRM practices, the SP 800-53 supply-chain control overlay and the Risk Exposure Framework; [../../context/frameworks/nist-ssdf-800-218.md](../../context/frameworks/nist-ssdf-800-218.md) — secure development practices and the producer self-attestation model
- Cloud assurance: [../../context/frameworks/csa-ccm-star.md](../../context/frameworks/csa-ccm-star.md) — CCM and CAIQ, and the public STAR registry to check before sending a questionnaire; [../../context/frameworks/iso-27017-27018-cloud.md](../../context/frameworks/iso-27017-27018-cloud.md) — cloud and PII-processor control guidance certified as an extension of an ISO 27001 scope; [../../context/regulations/eu-data-act.md](../../context/regulations/eu-data-act.md) — statutory cloud switching and exit rights to write into the contract
- Other attestations a vendor may offer: [../../context/frameworks/soc1-isae3402-soc-reports.md](../../context/frameworks/soc1-isae3402-soc-reports.md) — SOC 1 / ISAE 3402 and the rest of the SOC family; [../../context/frameworks/hitrust-csf.md](../../context/frameworks/hitrust-csf.md) — what e1, i1 and r2 certificates actually cover; [../../context/frameworks/fedramp.md](../../context/frameworks/fedramp.md) — US federal cloud certification classes and the state analogues; [../../context/frameworks/nist-800-171-cmmc.md](../../context/frameworks/nist-800-171-cmmc.md) — defence supply-chain flow-down and its limits on open plans of action; [../../context/frameworks/tisax-vda-isa.md](../../context/frameworks/tisax-vda-isa.md) — automotive supplier assessment exchange; [../../context/frameworks/swift-customer-security-programme.md](../../context/frameworks/swift-customer-security-programme.md) — the annual attestation counterparties can read
- Sector third-party regimes: [../../context/regulations/eu-dora-technical-standards.md](../../context/regulations/eu-dora-technical-standards.md) — register of information and the contractual/sub-outsourcing technical standards; [../../context/regulations/us-banking-incident-notification-third-party.md](../../context/regulations/us-banking-incident-notification-third-party.md) — the 2023 Interagency Guidance on Third-Party Relationships and its critical-activities tiering; [../../context/regulations/australia-apra-cps-234-230.md](../../context/regulations/australia-apra-cps-234-230.md) — CPS 230 material service providers and CPS 234's reach over third-party-managed assets; [../../context/regulations/uk-financial-operational-resilience.md](../../context/regulations/uk-financial-operational-resilience.md) — the critical third parties regime and material third-party reporting; [../../context/regulations/us-nydfs-part-500.md](../../context/regulations/us-nydfs-part-500.md) — the written third-party service provider policy and the contract terms it requires
- Transfers and subprocessors: [../../context/regulations/eu-gdpr-international-transfers.md](../../context/regulations/eu-gdpr-international-transfers.md) — transfer mechanisms to check when the vendor or its subprocessors sit outside the EEA
