...
2. **Methodology constraints** — existing risk matrix (scale dimensions, definitions), scoring method mandate (qualitative, semi-quantitative, [FAIR](../../context/frameworks/fair-cyber-risk-quantification.md)), and any framework alignment required (e.g., [ISO/IEC 27005](../../context/frameworks/iso-31000-27005-risk-management.md), [NIST SP 800-30](../../context/frameworks/nist-rmf-800-37-800-30.md)). See [risk scoring methodology](../../context/risk-scoring.md) before choosing — do not invent a scale if one exists.
...
- Method standards, when an alignment is mandated: [ISO 31000 and ISO/IEC 27005](../../context/frameworks/iso-31000-27005-risk-management.md) — principles, framework and process, and the event-based vs asset-based identification split; [NIST RMF with SP 800-39 and SP 800-30](../../context/frameworks/nist-rmf-800-37-800-30.md) — the seven-step process and the assessment method behind an explicit, named residual-risk acceptance; [COSO internal control and ERM](../../context/frameworks/coso-internal-control-erm.md) — how cyber risk reaches enterprise risk, strategy and board appetite
- Quantification, when ordinal scores cannot answer the question: [FAIR](../../context/frameworks/fair-cyber-risk-quantification.md) — the O-RT factor model and the O-RA method for sizing a named scenario as a loss-exposure distribution in currency
- Identification inputs: [MITRE ATT&CK, D3FEND and threat-informed defence](../../context/frameworks/mitre-attack-threat-informed-defense.md) — technique vocabulary for the threat half of a risk statement and for coverage evidence; [ISO 22301](../../context/frameworks/iso-22301-business-continuity.md) — the BIA outputs (MTPD, RTO, RPO) that anchor availability impact ratings
- Register roll-up: [NIST CSF 2.0 companion resources](../../context/frameworks/nist-csf-profiles-and-companion-resources.md) — Current/Target Organizational Profiles and the IR 8286 series that rolls a cyber risk register into the enterprise risk portfolio
